...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <span class="icon-list"></span><?php echo $text_list; ?> <b>/</b> <a onclick="display(\'grid\');"> <span class="icon-th"></span><?php echo $text_grid; ?></a>');
		...
		$('.display').html('<b> <?php echo $text_display; ?></b> <a onclick="display(\'list\');"> <span class="icon-list"></span><?php echo $text_list; ?></a> <b>/</b> <span class="icon-th"></span> <?php echo $text_grid; ?>');
