...
<script type="text/javascript">
   ...
   (function() {
    ...
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/adefault2/stylesheet/stylesheet-a.css" />
    <?php } else { ?>
...
<div id="header">
  ...
  <?php echo $cart; ?>
    ...
    <?php } else { ?>
    <input type="text" name="search" value="<?php echo $text_search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '#fff';" />
    <?php } ?>
  </div>
  <div id="welcome">
    <?php if (!$logged) { ?>
