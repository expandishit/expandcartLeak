	...
	<div id="content" class="cart one-page">	
		...
		<div class="inner pav-form">		
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="pav-form">
				<div class="cart-info wrapper margin">
					<table class="table">
							...
							<tr>
								...
								<td class="quantity">									
									...
									<div class="row-fluid">
										...
										<div class="span5">
											<input type="image" src="catalog/view/theme/<?php echo $themeName;?>/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />									
				...
				<div class="cart-module clearfix">
					<div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
							...
							<p><input type="text" name="coupon" value="<?php echo $coupon; ?>" class="span12" /></p>
							<input type="hidden" name="next" value="coupon" />							
							<p><input type="submit" value="<?php echo $button_coupon; ?>" class="button" /></p>
						</form>
					</div>
					<div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
							<p><?php echo $entry_voucher; ?></p>
							<p><input type="text" name="voucher" value="<?php echo $voucher; ?>" class="span12" /></p>
							<input type="hidden" name="next" value="voucher" />
							<p><input type="submit" value="<?php echo $button_voucher; ?>" class="button" /></p>							
						</form>
					</div>
					<div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
							<p><?php echo $entry_reward; ?></p>
							<p><input type="text" name="reward" value="<?php echo $reward; ?>" class="span12" /></p>
