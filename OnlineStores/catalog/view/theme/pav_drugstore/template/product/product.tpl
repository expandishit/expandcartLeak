...
<section class="span<?php echo $SPAN[1];?>">
	<div id="content" class="product-detail one-page">
		...
		<div class="product-info wrapper nopadding">
			<div class="row-fluid">
				<?php if ($thumb || $images) { ?>
				...
				<div class="span7 content-info">
					...
					<div class="price">
						<ul class="pav-price">
							<li>
								<span class="price-label"><?php echo $text_price; ?></span>	
								<?php if (!$special) { ?>
								<?php echo $price; ?>
								<?php } else { ?>										
								<span class="price-new highlight"><?php echo $special; ?></span>
								<span class="price-old highlight"><?php echo $price; ?></span>
								<?php } ?>
							</li>
							<li>
								<?php if ($tax) { ?>
					...
					<?php if ($options) { ?>
					<div class="options">
						<h3 class="l-option normal color"><?php echo $text_option; ?></h3>						
					...
					<div class="pav-group-button clearfix">
						...
						<div class="wishlist pull-left">
							<a onclick="addToWishList('<?php echo $product_id; ?>');" class="pavicon-wishlist"><?php echo $button_wishlist; ?></a>
						</div>
						<div class="compare pull-left">
							<a onclick="addToCompare('<?php echo $product_id; ?>');" class="pavicon-compare"><?php echo $button_compare; ?></a>
						</div>											
		...
		<div class="view-tabs">
			<div id="tabs" class="htabs clearfix">
				<ul id="tab">
					<li>
						<a class="box-heading" href="#tab-description"><?php echo $tab_description; ?></a>
					</li>
					
					<?php if ($attribute_groups) { ?>
					<li>	
						<a class="box-heading" href="#tab-attribute"><?php echo $tab_attribute; ?></a>
					</li>	
					<?php } ?>
					
					<?php if ($review_status) { ?>
					<li>
						<a class="box-heading" href="#tab-review"><?php echo $tab_review; ?></a>
					</li>
					<?php } ?>	

					<?php if( $productConfig['enable_product_customtab'] && isset($productConfig['product_customtab_name'][$languageID]) ) { ?>
					<li><a href="#tab-customtab" class="tab-link box-heading"><?php echo $productConfig['product_customtab_name'][$languageID]; ?></a></li>
					<?php } ?>

				</ul>				
			</div>
			
			<div id="tab-description" class="tab-content box-content">
				<?php echo $description; ?>
			</div>
			
			<?php if ($attribute_groups) { ?>
			<div id="tab-attribute" class="tab-content box-content">
			...
			<?php if ($review_status) { ?>
			<div id="tab-review" class="tab-content box-content">
				<div id="review"></div>
				...
				<p><img src="index.php?route=common/captcha" alt="" id="captcha" /></p>
