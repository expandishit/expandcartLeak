	...
	<div id="page-container">
						...
						<div class="span9">
							...
							<nav id="links" class="pull-left">
								<ul class="clearfix links">
									...
									<li class="first"><i class="icon-heart">&nbsp;</i><a href="<?php echo $wishlist; ?>" id="wishlist-total"><?php echo $text_wishlist; ?></a></li>
									<li><i class="icon-user">&nbsp;</i><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></li>
									<li><i class="icon-shopping-cart">&nbsp;</i><a href="<?php echo $shopping_cart; ?>"><?php echo $text_shopping_cart; ?></a></li>
									<li class="last"><i class="icon-building">&nbsp;</i><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></li>
								</ul>
							</nav>
						</div>
						<div class="span3 current-language">
							<?php echo $currency; ?>
						...
						<div class="span6">
							<div class="header-right clearfix">
								...
								<div id="search" class="pull-right b-white">
									<input type="text" name="search" placeholder="<?php echo $text_search; ?>" value="<?php echo $search; ?>" class="no-bg-color no-box" />
					...
					<div class="mainnav-inner">
						...
						<nav id="mainmenu">
							<div class="navbar">
								...
								<span class="hidden-desktop pull-left">Navigation</span>
		...
		if( count($modules) ){
			...
			<section class="pav-showcase" id="pavo-showcase">
				...
				<?php if( $i%$cols == 1 ){  $j=1;?><div class="row-fluid"><?php } ?>
