...
<div id="content content-product"><?php echo $content_top; ?>
...
<div class="col-lg-7">
    ...
    <div class="review">
        <div>
            <img src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/image/stars-<?php echo $rating; ?>.png"
...
<script type="text/javascript" src=" catalog/view/javascript/jquery/elevatezoom/elevatezoom-min-ar.js"></script>
<?php } else { ?>
