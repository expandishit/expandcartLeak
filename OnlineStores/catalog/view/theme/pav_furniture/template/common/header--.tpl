...
<body id="offcanvas-container"
      class="offcanvas-container fs<?php echo $themeConfig['fontsize'];?> <?php echo $helper->getPageClass();?> <?php echo $helper->getParam('body_pattern','');?>">
            ...
            <div class="row">
                <div class="col-lg-10 col-sm-10 center-sm">
                    <ul class="links pull-left">
                        <li><a class="first" href="<?php echo $home; ?>"><span class="icon-home"></span><?php echo $text_home; ?></a></li>
    ...
    <section id="header-main">
        <div class="container">
            <div class="row header-wrap">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 inner">
