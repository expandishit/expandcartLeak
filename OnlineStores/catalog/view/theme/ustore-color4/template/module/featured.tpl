    ...
    <div class="box-product">
      ...
      <div>
        ...
        <a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button1" title="Add to Cart"><span><?php echo $button_cart; ?></span></a>
            ...
            <a class="btn-detail ml10" title="Detail" href="<?php echo $product['href']; ?>"><span>التفاصيل</span></a>
            <?php } else { ?>
            <a class="btn-detail ml10" title="Detail" href="<?php echo $product['href']; ?>"><span>Detail</span></a>
            <?php } ?>
        </div>
        </div>
      </div>
