<div class="cet_container">
  <table style="border-collapse: collapse; width: 100%; border: none; background: #000000;">
    <tr>
	  <td style="padding: 20px 15px 15px 15px; background: #000000;" width="50%"><a href="{store_url}" title="{store_name}"><img src="{logo}" alt="{store_name}" style="margin-bottom: 0px; border: none;" /></a></td>
	...
	<tr>
	  <td colspan="2" valign="top">
	    <table style="border-collapse: collapse; width: 100%; border: none; background: #363636;">
	      <tr>
	        <td height="33" style="text-align: center; background: #363636;" width="110"><a href="http://opencart.com" title="Category 1" style="line-height: 33px; text-decoration: none;">Category 1</a></td>
			<td width="1" height="33" style="font-weight: 300; vertical-align: top; padding: 0; margin: 0; background: #5e5e5e;"></td>
			<td height="33" style="text-align: center; background: #363636;" width="110"><a href="http://opencart.com" title="Category 2" style="line-height: 33px; text-decoration: none;">Category 2</a></td>
			<td width="1" height="33" style="font-weight: 300; vertical-align: top; padding: 0; margin: 0; background: #5e5e5e;"></td>
			<td height="33" style="text-align: center; background: #363636;" width="110"><a href="http://opencart.com" title="Category 3" style="line-height: 33px; text-decoration: none;">Category 3</a></td>
			<td width="1" height="33" style="font-weight: 300; vertical-align: top; padding: 0; margin: 0; background: #5e5e5e;"></td>
			<td height="33" style="text-align: center; background: #363636;" width="110"><a href="http://opencart.com" title="Category 4" style="line-height: 33px; text-decoration: none;">Category 4</a></td>
			<td width="1" height="33" style="font-weight: 300; vertical-align: top; padding: 0; margin: 0; background: #5e5e5e;"></td>
			<td height="33" style="text-align: center; background: #363636;" width="110"><a href="http://opencart.com" title="Category 5" style="line-height: 33px; text-decoration: none;">Category 5</a></td>
	      </tr>
		</table>
	  </td>
	</tr>
