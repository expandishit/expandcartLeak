...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      <?php if ($thumb) { ?>
      <div class="image"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox"><img src="<?php echo $thumb; ?>" title="<?php echo $ALT_IMAGE; ?>" alt="<?php echo $ALT_IMAGE; ?>" id="image" /></a></div>
      <?php } ?>
      <?php if ($images) { ?>
      <div class="image-additional">
        <?php foreach ($images as $image) { ?>
        <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="colorbox"><img src="<?php echo $image['thumb']; ?>" title="<?php echo $ALT_IMAGE; ?>" alt="<?php echo $ALT_IMAGE; ?>" /></a>
        <?php } ?>
      </div>
      <?php } ?>
    </div>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
          <div class="share">
              ...
              <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-513a99f5721d81c3"></script>
              <!-- AddThis Button END -->
          </div>
      </div>
      <?php } ?>
  ...
  <div id="tab-attribute" class="tab-content">
    <table class="attribute">
      ...
      <?php if($attribute_group['name'] != "NOSHOW") { ?>
      <thead>
        <tr>
