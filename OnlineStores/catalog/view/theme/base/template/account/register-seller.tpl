  ...
  <form id="ms-accountinfo">
	...
	<div class="content">
		<table class="ms-product">
            ...
            <tr>
                <td><?php echo $ms_account_sellerinfo_creditcart; ?></td>
                <td>
                    <textarea name="seller_credit" id="message_textarea"></textarea>

                    <p class="ms-note"><?php echo $ms_account_sellerinfo_credit_note; ?></p>
                </td>
            </tr>
			<tr>
