...
<?php } ?>
    ...
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/bakers-choco/stylesheet/stylesheet-a.css" />
    <?php } else { ?>
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/bakers-choco/stylesheet/stylesheet.css" />
    <?php } ?>
