...
<div id="content" class="pav-block-view">
				...
				<?php if( !empty($samecategory) ) { ?>
					...
					<div class="span6">
						...
						<ul>
							...
							<li><i class="icon-angle-right"></i><a href="<?php echo $this->url->link('pavblog/blog',"id=".$item['blog_id']);?>"><?php echo $item['title'];?></a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
				...
				<?php }else { ?>
					...
					<form action="<?php echo $comment_action;?>" method="post" id="comment-form">
						...
						<div class="recaptcha">
							 ...
							 <p><img src="index.php?route=common/captcha" alt="" aligh="left"/></p>
						     <p><input type="text" name="captcha" value="<?php echo $captcha; ?>" size="10" /></p>						    
						</div>
						<?php } ?>
