			...
			<?php foreach ($returns as $return) { ?>
				<div class="return-list">
					...
					<div class="return-content">
						<div>
							<p><b><?php echo $text_date_added; ?></b> <?php echo $return['date_added']; ?></p>
							<p><b><?php echo $text_order_id; ?></b> <?php echo $return['order_id']; ?></p>
						</div>

						<div>
							<p><b><?php echo $text_customer; ?></b> <?php echo $return['name']; ?></p>
						</div>
