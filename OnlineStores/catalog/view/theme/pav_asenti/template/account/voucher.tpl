			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				...
				<table class="form table">
					<tr>
						...
						<td><input type="text" name="to_name" value="<?php echo $to_name; ?>" class="span8" />
					...
					<tr>
						...
						<td><input type="text" name="to_email" value="<?php echo $to_email; ?>" class="span8" />
					...
					<tr>
						...
						<td><input type="text" name="from_name" value="<?php echo $from_name; ?>" class="span8" />
					...
					<tr>
						...
						<td><input type="text" name="from_email" value="<?php echo $from_email; ?>" class="span8" />
					...
					<tr>
						...
						<td><input type="text" name="amount" value="<?php echo $amount; ?>" size="5" class="span8" />
							<?php if ($error_amount) { ?>
