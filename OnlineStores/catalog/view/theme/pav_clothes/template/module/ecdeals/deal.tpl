...
<?php } ?>
    <div class="wrap-grid-action" style="padding-bottom: 15px;">
       ...
       <?php if(isset($enable_buy_now) && $enable_buy_now){ ?>
              ...
              <input type="button" style="padding: 0px;" class="button btn btn-default btn-dailydeal" onclick="addToCart('<?php echo $product_id; ?>');" title="<?php echo $this->language->get("text_add_to_cart");?>" value="<?php echo $this->language->get("text_buy_now");?>">

              <?php } elseif($is_upcomming) { ?>

              <input type="button" style="padding: 0px;" class="button btn btn-default btn-dailydeal btn-upcomming" title="<?php echo $this->language->get("text_soon");?>" value="<?php echo $this->language->get("text_soon");?>">

              <?php } else { ?>

              <input type="button" style="padding: 0px;" class="button btn btn-default btn-dailydeal btn-expired" title="<?php echo $this->language->get("text_expired");?>" value="<?php echo $this->language->get("text_expired");?>">
