    	...
    	<div class="product-block">	
	      ...
	      <div class="image">
			<?php if ($product['stock_status'] != '') { ?>
				<span class="product-label-special label"><?php echo $product['stock_status'] ?></span>
	    	...
	    	<a class="img" href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
	      	...
	      	<a href="<?php echo $zimage;?>" class="colorbox product-zoom hidden-sm hidden-xs" rel="colorbox" title="<?php echo $product['name']; ?>"><span class="fa fa-search-plus"></span><span class="zoom_text">zoom</span></a>
	      	<?php } ?>
