...
<div id="content"><?php echo $content_top; ?>
    ...
    <div class="col-lg-5 image-container">
        ...
        <?php if( $special )  { ?>
          <div class="product-label-special label">
              <?php
                $price1 = preg_replace('#[^\d]+#', '', $price);
                $special1 = preg_replace('#[^\d]+#', '', $special);
                $discount = round(100*($price1 - $special1)/$price1);
                echo sprintf($this->language->get('text_sale_detail'), (int)$discount);
              ?>
          </div>
        <?php } ?>
          <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox">
          <?php if($config_show_manfacture_image) { ?>
              <img style="position:relative;" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image"  data-zoom-image="<?php echo $popup; ?>" class="product-image-zoom"/>
              <img style="position: absolute;left: 5px;top: 5px;" src="<?php echo $manufacturer_thumb; ?>" title="<?php echo $manufacturer; ?>" alt="<?php echo $manufacturer; ?>" id="manufacturer_thumb" />
          <?php } else { ?>
     ...
     <?php } ?>
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <label><?php echo $option['name']; ?>:</label>
          <input class="btn btn-primary" type="button" value="<?php echo $button_upload; ?>" id="button-option-<?php echo $option['product_option_id']; ?>" class="button">
  ...
  <div id="tab-review" class="tab-content">
    ...
    <span class="form-group"><img src="index.php?route=common/captcha" alt="" id="captcha" /></span>
