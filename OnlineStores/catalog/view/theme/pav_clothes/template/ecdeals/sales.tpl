...
<div class="col-md-12">
    <div id="content" class="special">
      ...
      ?>
                <li class="<?php echo $class; ?>"><a class="btn btn-default" href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></li>
                <?php } ?>
            </ul>
            <?php } else { ?>
      ...
      ?>
        ...
        <div class="form" style="text-align: center; margin-bottom: 19px;">
          ...
          <input type="text" style="height: 34px; margin-bottom: 0px; width: auto;" value="<?php echo isset($search)?$search:''; ?>" name="search">
            <input type="button" style="margin-top: 4px;" class="button btn btn-default" id="button-search" value="<?php echo $this->language->get("text_search"); ?>">
        </div>
	...
	foreach ($products as $i => $product) { ?>
                ...
                <div class="row">
                    <?php } ?>
                    <div class="col-md-<?php echo $span;?>"><?php echo $this->getChild('module/ecdeals/deal', array($product['product_id'], array())); ?></div>
