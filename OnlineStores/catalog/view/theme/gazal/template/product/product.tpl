  ...
  <div class="product-info">
    ...
    <div class="right">
      ...
      <div class="description">
        ...
        ?>
          <?php if ($manufacturerimg != '') { ?>
        <div><img class="manufacturer-img" src="<?php echo $path_image . $manufacturerimg; ?>" alt="<?php echo $manufacturer; ?>" /></div>
          <?php } ?>
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $heading_title ?>",
  "image": [
    "<?= $thumb ?>"<?= count($images) > 0 ? ',' : '' ?>
    <?php $i = 0; foreach( $images as $addimage) { ?>
    "<?= $addimage['thumb'] ?>"<?= ++$i === count($images) ? "" : "," ?>
    <?php } ?>
   ],
  ...
  <?php if($reviews_count > 0 && $rating > 0) { ?>
  "aggregateRating": {
  ...
  "offers": {
    ...
    "price": "<?= $special_number ? $special_number : $price_number ?>",
    "availability": <?php if($quantity > 0) { ?>"http://schema.org/InStock"<?php } else { ?>"http://schema.org/OutOfStock"<?php } ?>,
    "seller": {
      "@type": "Organization",
