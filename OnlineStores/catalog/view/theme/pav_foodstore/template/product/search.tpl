...
<?php echo $content_top; ?>
  ...
  <div class="content">
    ...
    <label for="description"><?php echo $entry_description; ?></label>
	  ...
	  <div>
		  <label for="specific_city_for_search"><?= $specific_city_for_search; ?></label>
		  <input id="specific_city_for_search" type="checkbox" <?= (!is_null($city_id) ? 'checked="checked"' : ''); ?> />
		  <select id="search_in_city" name="search_in_city" <?= (is_null($city_id) ? 'style="display: none;" disabled="true"' : ''); ?> >
              <?php foreach ($search_by_city['zones'] as $zone) { ?>
			  <option value="<?= $zone['zone_id']; ?>" <?= (!is_null($city_id) and $zone['zone_id'] == $city_id) ? 'selected' : ''; ?> ><?= $zone['name']; ?></option>
              <?php } ?>
		  </select>
	  </div>
	  <?php } ?>
    	...
    	<div class="product-block">	
	      ...
	      <div class="image"><?php if( $product['special'] ) {   ?>
	    	...
	    	<a class="img" href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
      		...
      		<?php if ($quickview) { ?>
			<a class="pav-colorbox hidden-sm hidden-xs" href="index.php?route=themecontrol/product&product_id=<?php echo $product['product_id']; ?>"><span class='icon-eye-open'></span><?php echo $this->language->get('quick_view'); ?></a>
			<?php } ?>
			<?php 
  			if( $swapimg ){
