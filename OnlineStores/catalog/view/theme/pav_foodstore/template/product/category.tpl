    	...
    	<div class="product-block">	
	      ...
	      <div class="image"><?php if( $product['special'] ) {   ?>
	    	...
	    	<a class="img" href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
			  ...
			  <div style="position:absolute;background-color:black;color:white;top:3px;left:5px;padding:10px;font-size:16px;z-index:5;"><?php echo $product['stock_status']; ?></div>
			  <?php } ?>
			...
			<?php if ($quickview) { ?>
			<a class="pav-colorbox hidden-sm hidden-xs" href="index.php?route=themecontrol/product&product_id=<?php echo $product['product_id']; ?>"><span class='icon icon-eye'></span><?php echo $this->language->get('quick_view'); ?></a>
			<?php } ?>
