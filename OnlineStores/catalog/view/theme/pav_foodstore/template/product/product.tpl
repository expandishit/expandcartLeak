   ...
   <div id="related" class="slide product-grid" data-interval="0">
    ...
    <div class="box-content products-block carousel-inner">
      ...
      <div class="image">
        ...
        <a id="colorbox_<?php echo $product['product_id'];?>" class="img" href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
		<script type="text/javascript">
