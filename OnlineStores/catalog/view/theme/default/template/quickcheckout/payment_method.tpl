...
<div class="box box-border" >
  ...
  <div class="box-content ">
    ...
    <div class="payment-methods <?php if (!$data['display_options']) {  echo 'qc-hide';  } ?>">
      ...
      <!--
        // for sadad payement
      <input type="radio" name="payment_method" value="payfort_fort_sadad" id="payfort_fort_sadad" class="styled"  data-refresh="6"/>
      <label for="payfort_fort_sadad">
                  سداد<span class="price"></span></label>
                -->
