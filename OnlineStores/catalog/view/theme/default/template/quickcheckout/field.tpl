...
<?php	break; case "location": ?>
      <div id="<?php echo $field['id']; ?>_input" class="location-input sort-item <?php echo (!$field['display'])? 'qc-hide' : ''; ?> <?php echo ($field['class'])? $field['class'] : ''; ?>" data-sort="<?php echo $field['sort_order']; ?>">
        <label for="<?php echo $name; ?>_<?php echo $field['id']; ?>"> <span class="required <?php echo (!isset($field['require']) ||  !$field['require']) ? 'qc-hide' : ''; ?>">*</span> <span class="text"><?php echo $field['title']; ?></span> <?php echo (!empty($field['tooltip']))? '<i class="icon-help" rel="tooltip" data-help="'.$field['tooltip'] .'"></i>' : '' ; ?></label>
        <div id="map_<?php echo $name; ?>_<?php echo $field['id']; ?>" style="width: 99%; height: 200px; margin-bottom: 5px;"></div>
        <input type="hidden" name="<?php echo $name; ?>[<?php echo $field['id']; ?>]" id="<?php echo $name; ?>_<?php echo $field['id']; ?>" />
      </div>
