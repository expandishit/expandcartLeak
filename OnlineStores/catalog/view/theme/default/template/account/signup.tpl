  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
       ...
       <?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['f_name_show']) { ?>
        ...
        <?php } ?>
         <?php if (!$isActive['enablemod'] || ($isActive['enablemod'] && !$isActive['single_box']
            && ($modData['company_show'] || $modData['companyId_show']||$modData['address1_show']|| $modData['address2_show']
    ...
    <div class="content">
      <table class="form">
        ...
        <?php } ?>
        <?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['state_show'] && $modData['country_show']) { ?>
        <tr>
    ...
    <div class="content">
      <table class="form">
        ...
        <tr>
          ...
          <td><?php if ($newsletter || in_array($isActive['newsletter_sub_enabled'], ['1', 1])) { ?>
