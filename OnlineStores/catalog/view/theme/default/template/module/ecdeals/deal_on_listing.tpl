...
?>
<div class="product-inner" id="ecdeal<?php echo $module_id; ?>">
    <?php if ($deal['thumb']) { ?>
    <div class="image">
        <?php if( $deal['special'] ) {   ?>
    ...
    <div class="product-meta detail-deal">
        ...
        <input type="button" class="button btn-dailydeal" style="float: none;margin-top: 5px;margin-bottom: 9px;" onclick="addToCart('<?php echo $product_id; ?>');" title="<?php echo $this->language->get("text_add_to_cart");?>" value="<?php echo $this->language->get("text_buy_now");?>">
        <?php } elseif($is_upcomming) { ?>
        <input type="button" class="button btn-dailydeal btn-upcomming" style="float: none;margin-top: 5px;margin-bottom: 9px;" title="<?php echo $this->language->get("text_soon");?>" value="<?php echo $this->language->get("text_soon");?>">
        <?php } else { ?>
        <input type="button" class="button btn-dailydeal btn-expired" style="float: none;margin-top: 5px;margin-bottom: 9px;" title="<?php echo $this->language->get("text_expired");?>" value="<?php echo $this->language->get("text_expired");?>">
        <?php } ?>
        <?php } ?>
