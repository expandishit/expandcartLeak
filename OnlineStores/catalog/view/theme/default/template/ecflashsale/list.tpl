...
<div id="content"><?php echo $content_top; ?>
 ...
 <?php } ?>
  ...
  <?php if ($flashsales) { ?>
  <div id="list_flashsale_item" class="row-fluid product-list flashsale-list">
    <?php
    $cols = 3;
    $span = floor(12/$cols);
    $i = 0;
    ...
    <?php } ?>
      <div class="span<?php echo $span;?> product-item<?php echo $flashsale['featured']?' featured':''; ?> col-fullwidth  block-flashsale">
        <div class="image">   
