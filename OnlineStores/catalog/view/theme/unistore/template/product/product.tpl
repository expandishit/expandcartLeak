  ...
  <div class="product-info">
    ...
    <div class="right">
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option"><p>
          <?php if ($option['required']) { ?>
          <span class="required">*</span>
          <?php } ?>
          <?php echo $option['name']; ?>:</p>
      ...
      <div class="cart">
        ...
        <div class="wish-list"><a onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></div>
        <?php if ($minimum > 1) { ?>
        <div class="minimum" style="padding-top:7px;font-size:11px"><?php echo $text_minimum; ?></div>
        <?php } ?>
      </div>
