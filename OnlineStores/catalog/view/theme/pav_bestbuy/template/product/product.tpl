        ...
        <?php if ($price) { ?>
          <div class="price">
           <?php if (!$special) { ?>
              <?php echo $price; ?>
              <?php } else { ?>
              <div class="price-old"><?php echo $price; ?></div> <div class="price-new"><?php echo $special; ?></div>
              <?php } ?>
          </div>
      <?php } ?>
     ...
     <div class="addition-actions">
       <span class="cart-info product-extra">
          ...
          <input type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" />
            <span class="add-up add-action"><span class="fa fa-plus"></span></span> <span class="add-down add-action"><span class="fa fa-minus"></span></span>
          </span>
