...
?>
<!DOCTYPE html>
<html class="<?php echo $helper->getDirection(); ?>" lang="<?php echo $lang; ?>"
...
<body id="offcanvas-container" class="keep-header offcanvas-container layout-<?php echo $layoutMode; ?> fs<?php echo $themeConfig['fontsize'];?> <?php echo $helper->getPageClass();?> <?php echo $helper->getParam('body_pattern','');?> lang-<?php echo $lang; ?>">
    ...
    <section id="header">
		<section id="topbar">
			<div class="container">
                <div class="topbar">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 header-right">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12 hidden-xs header-left">
                            <div class="welcome pull-right">
                                <?php if (!$logged) { ?>
                                <?php echo $text_welcome_pav_cosmetics; ?>
                                <?php } else { ?>
                                <?php echo $text_logged_pav_cosmetics; ?>
                                <?php } ?>
                            </div>
                            <ul class="hidden-sm hidden-xs hidden-md links pull-right">
                            ...
                            <ul class="visible-md acount-mini pull-left">
                                <h4>
                                    <li class="btn"><a><?php echo $text_account; ?>&nbsp;&nbsp;&nbsp;<i class="icon-angle-down"></i></a></li>
        ...
        <section id="pav-mainnav" class="">
	        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="mini-access visible-xs visible-sm col-sm-12 col-xs-12">
                        <a class="first" href="<?php echo $home; ?>"><?php echo $text_home; ?></a>
                        <a class="wishlist" href="<?php echo $wishlist; ?>"
                           id="wishlist-total"><?php echo $text_wishlist; ?></a>
                        <a class="account" href="<?php echo $account; ?>"><?php echo $text_account; ?></a>
                        <a class="shoppingcart"
                           href="<?php echo $shopping_cart; ?>"><?php echo $text_shopping_cart; ?></a>
                    ...
                    <div class="header-right pull-right wrap-cart hidden-xs col-lg-2 col-md-2 col-sm-3">
                        <div class="cart-top">
                            <?php echo $cart; ?>
                        </div>
                    </div>
