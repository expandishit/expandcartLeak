...
<section id="topbar">
	<div class="container">
		<div class="row">
			<div class="<?php echo $direction == 'rtl' ? 'col-lg-5' : 'col-lg-5'; ?> col-md-4 hidden-sm hidden-xs">
			...
			<div class="<?php echo $direction == 'rtl' ? 'col-lg-7' : 'col-lg-7'; ?> col-md-8 hidden-sm hidden-xs">
			...
			<div class="show-mobile hidden-lg hidden-md pull-right">
                <a class="quick-cart pull-left" href="<?php echo $shopping_cart; ?>">
