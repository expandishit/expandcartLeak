...
<div id="pavcontentslider<?php echo $id;?>" class="carousel slide pavcontentslider">
    ...
    <a class="carousel-control left" href="#pavcontentslider<?php echo $id;?>" data-slide="prev">&rsaquo;</a>
    <a class="carousel-control right" href="#pavcontentslider<?php echo $id;?>" data-slide="next">&lsaquo;</a>
    <?php } else { ?>
