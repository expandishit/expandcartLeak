...
if (view == 'list') {
	...
	$('.product-list div.product_block').each(function(index, element) {
		...
		$('.display').html('<span style="float: left;margin:4px 5px 0 0;"><?php echo $text_display; ?></span><a class="list active"><?php echo $text_list; ?></a><a class="grid"  onclick="display(\'grid\');"><?php echo $text_grid; ?></a>');
...
$.totalStorage('display', 'list'); 
	...
	$('.product-grid div.product_block').each(function(index, element) {
		...
		$('.display').html('<span style="float: left;margin:4px 5px 0 0;"><?php echo $text_display; ?></span><a class="list" onclick="display(\'list\');"><?php echo $text_list; ?></a><a class="grid active"><?php echo $text_grid; ?></a>');
