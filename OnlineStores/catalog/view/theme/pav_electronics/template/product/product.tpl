    ...
    <div class="span5 image-container">
        ...
        <div class="image-additional slide carousel" id="image-additional"><div class="carousel-inner">
            ...
            <?php if ($this->language->get('direction') == 'rtl') { ?>
                <div class="carousel-control left" href="#image-additional" data-slide="prev">&rsaquo;</div>
                <div class="carousel-control right" href="#image-additional" data-slide="next">&lsaquo;</div>
            <?php } else { ?>
...
<div class="tabs-group">
  ...
  <div class=" box product-related">
   <div class="box-heading"><h4> <?php echo $tab_related; ?> (<?php echo count($products); ?>)</h4></div>
