  ...
  <div class="box-content">
    ...
    ?>
      <li class="<?php echo $class; ?>">
        ...
        <a href="<?php echo $category['href']; ?>" class="active"><i class="fa fa-asterisk"></i><?php echo $category['name']; ?></a>
        <?php } else { ?>
        <a href="<?php echo $category['href']; ?>"><i class="fa fa-asterisk"></i><?php echo $category['name']; ?></a>
        <?php } ?>
