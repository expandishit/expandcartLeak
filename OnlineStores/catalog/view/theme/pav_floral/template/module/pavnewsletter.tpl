		...
		<div class="col-sm-6 block_content">
				...
				<div class="wrap-input">
					...
					<!--<select name="action">
						...
						<button type="submit" name="submitNewsletter" class="button_mini pull-right" value="<?php echo $this->language->get("button_ok");?>" ><i class="fa fa-long-arrow-right"></i></button>
