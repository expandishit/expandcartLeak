			...
			<div class="container"><div class="topbar"><div class="row">
				<div class="col-lg-8 col-md-6 col-sm-5 hidden-xs">
					<ul class="links  pull-left">
						<li class="hidden-sm hidden-xs"><a href="<?php echo $wishlist; ?>" id="wishlist-total"><span class="fa fa-heart"></span><?php echo $text_wishlist; ?></a></li>
						...
						<li class="hidden-sm hidden-xs"><a class="last" href="<?php echo $checkout; ?>"><span class="fa fa-file"></span><?php echo $text_checkout; ?></a></li>
					</ul>
...
<div id="pav-mainnav">
			...
			<?php } ?>
					...
					<div class="mini-access visible-xs pull-right">
						<ul>
							<li><a href="<?php echo $wishlist; ?>" class="mini_wishlist"><i class="fa fa-heart"></i></a></li>
							<li><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="mini_account"><span class="fa fa-user"></span></a></li>
							<li><a href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>" class="mini_cart"><span class="fa fa-shopping-cart"></span></a></li>
...
<?php } ?>
	...
	<div class="row visible-xs visible-sm"><div class="container"> 
		<div class="offcanvas-sidebars-buttons">
			<button type="button" data-for="column-left" class="pull-left btn btn-danger"><i class="glyphicon glyphfa fa-indent-left"></i> <?php echo $this->language->get('text_sidebar_left'); ?></button>
			
			<button type="button" data-for="column-right" class="pull-right btn btn-danger"><?php echo $this->language->get('text_sidebar_right'); ?> <i class="glyphicon glyphfa fa-indent-right"></i></button>
		</div>
	</div></div>
	<?php }else { ?>
