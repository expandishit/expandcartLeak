...
<div class="row">
	<div class="blog-meta col-lg-4 col-md-4 col-sm-6 col-xs-12">
		...
		<li class="created">
			<span class="fa fa-time ">   <?php echo $this->language->get("text_created");?> :</span>
		...
		<li class="hits"><span class="fa fa-eye-open">   <?php echo $this->language->get("text_hits");?></span> <?php echo $blog['hits'];?></li>
		<?php } ?>
