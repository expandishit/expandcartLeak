...
$(document).ready(function(){
    ...
    RewardPoints.Views.onCheckout   =   Backbone.View.extend({
        ...
        onChangeSlider: function(){
			...
			if($("#payment-method").length == 0){
				var loading = '<div style="text-align: center; min-height: 26px;"><img src="catalog/view/javascript/rewardpoints/image/loading.gif"/> Updating cart...</div>';
				...
				var loading = '<a><img src="catalog/view/javascript/rewardpoints/image/loading.gif"> Updating points...</a>';
