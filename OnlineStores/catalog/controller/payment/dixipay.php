...
class ControllerPaymentDixipay extends Controller {
    ...
    protected function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/dixipay.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/payment/dixipay.tpl';
        } else {
            $this->template = 'default/template/payment/dixipay.tpl';
        }
