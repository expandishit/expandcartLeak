...
class ControllerAccountAramexTraking extends Controller {
	...
	public function getForm() {
		...
		if ($order_info) {
			...
			$this->data['heading_title'] = $this->language->get('Armex Tracking');
	...
	if($results->HasErrors){
		...
		################## create shipment end ###########
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/aramex_tracking.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/account/aramex_tracking.tpl';
			} else {
				$this->template = 'default/template/account/aramex_tracking.tpl';
			}
	...
	function getTrackingInfoTable($HAWBHistory) {
        ...
        $_resultTable = '<table summary="Item Tracking"  class="list">';
