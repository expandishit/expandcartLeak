	...
	public function index() { 
		...
		if ($product_info) {
            ...
            if ($auto_meta_tags_module_status == '1')
            {
                ...
                // set meta keywords
                $meta_keywords = $this->model_module_auto_meta_tags->generate_meta_keywords($product_info);
            ...
            if ($manufacturer_info['image']) {
                $this->data['manufacturer_thumb'] = $this->model_tool_image->resize($manufacturer_info['image'], 100, 100);
            } else {
			...
			if ((float)$product_info['special']) {
                ...
                $this->data['special_number'] = $this->tax->calculate($product_info['special'], $product_info['tax_class_id'], $this->config->get('config_tax'));
			} else {
