...
class ModelAccountOrder extends Model {
	...
	public function getOrder($order_id, $seller_id = NULL) {

		 if(\Extension::isInstalled('multiseller') && !empty($seller_id)) 
			{
				$query = "SELECT * FROM `" . DB_PREFIX . "order` AS o, `" . DB_PREFIX . "ms_order_product_data` AS m WHERE o.order_id = m.order_id AND o.order_id = " . (int)$order_id . " AND m.seller_id = " . (int)$seller_id . " AND o.order_status_id > '0'";
			}
		else 
			{
				$query = "SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "' AND customer_id = '" . (int)$this->customer->getId() . "' AND order_status_id > '0'";
			}
