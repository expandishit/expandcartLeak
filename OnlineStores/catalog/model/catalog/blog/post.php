...
class ModelCatalogBlogPost extends Model
{
    /**
     ...
     * @return array|bool
     */
    public function getLatestPosts($count = 10, $language_code)
    {
     ...
     * @return array|bool
     */
    public function getPostsByCategoryId($categoryId, $language_code)
    {
        ...
        $lanaguagesQuery[] = 'WHERE code="' . $language_code . '"';
        ...
        foreach ($data->rows as $row) {
            $allPosts[$row['post_id']][$language['language_id']] = $row;
        }
     ...
     * @return array|bool
     */
    public function getPostById($postId, $language_code)
    {
        $queryString = $lanaguagesQuery = [];
