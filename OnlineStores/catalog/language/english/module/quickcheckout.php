...
$_['sms_conf_msg'] = 'You have to verify your phone number, we have sent you a confirmation code via SMS, please enter it here then click on Verify <br> <br> Please note that you have to write your phone with the country code, if you did not do that, please click cancel and edit the number';
$_['sms_conf_resend'] = 'Resend SMS';
$_['sms_conf_verify'] = 'Verify';
$_['sms_conf_cancel'] = 'Cancel';
$_['sms_conf_error'] = 'Confirmation code is wrong';

$_['whats_conf_msg'] = 'You have to verify your phone number, we have sent you a confirmation code via whatsApp Message, please enter it here then click on Verify <br> <br> Please note that you have to write your phone with the country code, if you did not do that, please click cancel and edit the number';
$_['whats_conf_resend'] = 'Resend WhatsApp Message';
$_['whats_conf_verify'] = 'Verify';
$_['whats_conf_cancel'] = 'Cancel';
$_['whats_conf_error'] = 'Confirmation code is wrong';
?>