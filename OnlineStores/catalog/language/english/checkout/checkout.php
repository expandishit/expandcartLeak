...
$_['error_login_username']           = 'Warning: No match for Username and/or Password.';
...
$_['error_no_shipping']              = 'Warning: Our shipping services does not cover the selected area. Please <a href="%s">contact us</a> for assistance!';
$_['error_payment']                  = 'Warning: Payment method required!';
$_['error_no_payment']               = 'Warning: No payment methods available for the current order total or the available payment methods does not cover the selected area. Please <a href="%s">contact us</a> for assistance!';
$_['error_send_as_gift']             = 'Warning: You must agree to the %s!';
?>