...
$_['tab_video']         = 'External Video';
$_['tab_review']        = 'Reviews (%s)';
$_['tab_related']       = 'Related Products'; 

// Error
$_['error_product']        = 'Warning: Review product is required!';
$_['error_name']        = 'Warning: Review Name must be between 3 and 25 characters!';
$_['error_text']        = 'Warning: Review Text must be between 3 and 1000 characters!';
$_['error_rating']      = 'Warning: Please select a review rating!';
$_['error_captcha']     = 'Warning: Verification code does not match the image!';
$_['error_upload']      = 'File size is large, this file cannot be uploaded. Please contact customer service.';
$_['error_filename']    = 'Filename must be between 3 and 64 characters!';
$_['error_filetype']    = 'Please contact customer service to be able to upload this type of files.';
...
$_['text_bids'] 		= 'Bids';
$_['text_notfound'] 		= 'No Trips Availabe';
?>