 ...
 */
$path = DIR_APPLICATION.'../Lib/amazon/amazon/src/';
require_once($path.'MarketplaceWebService/Interface.php');
require_once($path.'MarketplaceWebService/RequestType.php');
...
class MarketplaceWebService_Client implements MarketplaceWebService_Interface
{
    ...
    const PATH = '/../Lib/amazon/amazon/src/';
  /** @var string */
   ...
   */
    public function getReport($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportRequest.php');
            $request = new MarketplaceWebService_Model_GetReportRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportResponse.php');
   ...
   */
    public function getReportScheduleCount($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleCountRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportScheduleCountRequest.php');
            $request = new MarketplaceWebService_Model_GetReportScheduleCountRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportScheduleCountResponse.php');
   ...
   */
    public function getReportRequestListByNextToken($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportRequestListByNextTokenRequest.php');
            $request = new MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportRequestListByNextTokenResponse.php');
   ...
   */
    public function updateReportAcknowledgements($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/UpdateReportAcknowledgementsRequest.php');
            $request = new MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/UpdateReportAcknowledgementsResponse.php');
   ...
   */
    public function submitFeed($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_SubmitFeedRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/SubmitFeedRequest.php');
            $request = new MarketplaceWebService_Model_SubmitFeedRequest($request);
        }

        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/SubmitFeedResponse.php');
   ...
   */
    public function getReportCount($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportCountRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportCountRequest.php');
            $request = new MarketplaceWebService_Model_GetReportCountRequest($request);
        }

        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportCountResponse.php');
   ...
   */
    public function getFeedSubmissionListByNextToken($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionListByNextTokenRequest.php');
            $request = new MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionListByNextTokenResponse.php');
   ...
   */
    public function cancelFeedSubmissions($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_CancelFeedSubmissionsRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/CancelFeedSubmissionsRequest.php');
            $request = new MarketplaceWebService_Model_CancelFeedSubmissionsRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/CancelFeedSubmissionsResponse.php');
   ...
   */
    public function requestReport($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_RequestReportRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/RequestReportRequest.php');
            $request = new MarketplaceWebService_Model_RequestReportRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/RequestReportResponse.php');
   ...
   */
    public function getFeedSubmissionCount($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionCountRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionCountRequest.php');
            $request = new MarketplaceWebService_Model_GetFeedSubmissionCountRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionCountResponse.php');
   ...
   */
    public function cancelReportRequests($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_CancelReportRequestsRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/CancelReportRequestsRequest.php');
            $request = new MarketplaceWebService_Model_CancelReportRequestsRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/CancelReportRequestsResponse.php');
   ...
   */
    public function getReportList($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportListRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportListRequest.php');
            $request = new MarketplaceWebService_Model_GetReportListRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportListResponse.php');
   ...
   */
    public function getFeedSubmissionResult($request)
    {
        ...
        if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionResultRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionResultRequest.php');
            $request = new MarketplaceWebService_Model_GetFeedSubmissionResultRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionResultResponse.php');
   ...
   */
    public function getFeedSubmissionList($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionListRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionListRequest.php');
            $request = new MarketplaceWebService_Model_GetFeedSubmissionListRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetFeedSubmissionListResponse.php');
   ...
   */
    public function getReportRequestList($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportRequestListRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportRequestListRequest.php');
            $request = new MarketplaceWebService_Model_GetReportRequestListRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportRequestListResponse.php');
   ...
   */
    public function getReportScheduleListByNextToken($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportScheduleListByNextTokenRequest.php');
            $request = new MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportScheduleListByNextTokenResponse.php');
   ...
   */
    public function getReportListByNextToken($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportListByNextTokenRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportListByNextTokenRequest.php');
            $request = new MarketplaceWebService_Model_GetReportListByNextTokenRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportListByNextTokenResponse.php');
   ...
   */
    public function manageReportSchedule($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_ManageReportScheduleRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/ManageReportScheduleRequest.php');
            $request = new MarketplaceWebService_Model_ManageReportScheduleRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/ManageReportScheduleResponse.php');
   ...
   */
    public function getReportRequestCount($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportRequestCountRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportRequestCountRequest.php');
            $request = new MarketplaceWebService_Model_GetReportRequestCountRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportRequestCountResponse.php');
   ...
   */
    public function getReportScheduleList($request)
    {
        if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleListRequest) {
            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportScheduleListRequest.php');
            $request = new MarketplaceWebService_Model_GetReportScheduleListRequest($request);
        }
        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/GetReportScheduleListResponse.php');
            ...
            do {
                try {
                    ...
                    switch ($httpStatus) {
                        ...
                        case 500:
                        case 503:
                            require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/ErrorResponse.php');
                    ...
                    require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Exception.php');
   ...
   */
    private function performRequest($action, array $converted, $dataHandle = null, $contentMd5 = null)
    {
        ...
        $ch = curl_setopt_array($this->curlClient, $curlOptions);
        ...
        if(!isset($parsedHeader['x-mws-request-id']))
            $parsedHeader['x-mws-request-id'] = '';

        if(!isset($parsedHeader['x-mws-response-context']))
            $parsedHeader['x-mws-response-context'] = '';

        if(!isset($parsedHeader['x-mws-timestamp']))
            $parsedHeader['x-mws-timestamp'] = '';

        require_once(DIR_APPLICATION.self::PATH.'MarketplaceWebService/Model/ResponseHeaderMetadata.php');
