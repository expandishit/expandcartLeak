...
class MarketplaceWebService_Model_GetFeedSubmissionListRequest extends MarketplaceWebService_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'FeedSubmissionIdList' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_IdList'],
        'MaxCount' => ['FieldValue' => null, 'FieldType' => 'string'],
        'FeedTypeList' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_TypeList'],
        'FeedProcessingStatusList' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_StatusList'],
