...
class MarketplaceWebService_Model_GetFeedSubmissionResultResponse extends MarketplaceWebService_Model
{
    ...
    {
        $this->fields =  [
        'GetFeedSubmissionResultResult' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_GetFeedSubmissionResultResult'],
        'ResponseMetadata' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_ResponseMetadata'],
        ];
