...
require_once($path.'MarketplaceWebService/Model.php');
...
class MarketplaceWebService_Model_GetReportRequestListRequest extends MarketplaceWebService_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'ReportRequestIdList' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_IdList'],
        'ReportTypeList' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_TypeList'],
        'ReportProcessingStatusList' => ['FieldValue' => null, 'FieldType' => 'MarketplaceWebService_Model_StatusList'],
