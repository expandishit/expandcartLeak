  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <br />
        <table id="route" class="table table-hover dataTable no-footer">
          <thead>
            <tr>
          ...
          <tbody id="route-row<?php echo $route_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#route-row<?php echo $route_row; ?>').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $route_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addRoute();" class="button btn btn-primary"><?php echo $button_add_route; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addRoute() {
	...
	html += '    <td class="left"><a onclick="$(\'#route-row' + route_row + '\').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
