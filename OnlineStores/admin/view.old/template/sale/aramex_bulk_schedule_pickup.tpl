...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
          <?php if ($orders) { ?>
			<a onclick="$('#form').attr('action', '<?php echo $create; ?>'); $('#form').submit();" class="button btn btn-primary"><?php echo $text_create; ?>
			</a>
          <?php } ?>
	  </div>
    </div>
...
function filter() {
	url = 'index.php?route=sale/aramex_bulk_schedule_pickup&token=<?php echo $token; ?>';
