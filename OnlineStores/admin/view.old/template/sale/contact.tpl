...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a id="button-send" onclick="send('index.php?route=sale/contact/send&token=<?php echo $token; ?>');" class="button btn btn-primary"><?php echo $button_send; ?></a><a href="<?php echo $cancel; ?>" class="button btn btn-primary"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
...
$('input[name=\'customers\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#customer').append('<div id="customer' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" name="customer[]" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#customer div i', function() {
	$(this).parent().remove();
...
$('input[name=\'affiliates\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#affiliate').append('<div id="affiliate' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" name="affiliate[]" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#affiliate div i', function() {
	$(this).parent().remove();
...
$('input[name=\'products\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#product').append('<div id="product' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" name="product[]" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#product div i', function() {
	$(this).parent().remove();
