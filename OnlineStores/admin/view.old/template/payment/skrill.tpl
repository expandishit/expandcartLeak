      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="skrill_email" value="<?php echo $skrill_email; ?>" />
              <?php if ($error_email) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="skrill_secret" value="<?php echo $skrill_secret; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_total; ?></td>
            <td><input type="text" name="skrill_total" value="<?php echo $skrill_total; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_order_status; ?></td>
            <td><select name="skrill_order_status_id">
          ...
          <tr>
            ...
            <td><select name="skrill_pending_status_id">
                <?php foreach ($order_statuses as $order_status) { ?>
          ...
          <tr>
            ...
            <td><select name="skrill_canceled_status_id">
                <?php foreach ($order_statuses as $order_status) { ?>
          ...
          <tr>
            ...
            <td><select name="skrill_failed_status_id">
                <?php foreach ($order_statuses as $order_status) { ?>
          ...
          <tr>
            ...
            <td><select name="skrill_chargeback_status_id">
                <?php foreach ($order_statuses as $order_status) { ?>
          ...
          <tr>
            ...
            <td><select name="skrill_geo_zone_id">
          ...
          <tr>
            ...
            <td><select name="skrill_status">
                <?php if ($skrill_status === "1") { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                <?php } elseif ($skrill_status === "0") { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="skrill_sort_order" value="<?php echo $skrill_sort_order; ?>" size="3" /></td>
          </tr>
        </table>
      </form>
    </div>
