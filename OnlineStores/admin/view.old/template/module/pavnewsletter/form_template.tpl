      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
           ...
           <table class="form">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="template[template_file]" value="<?php echo isset($template['template_file'])?$template["template_file"]:""; ?>" /> <a id="button-upload" class="button btn btn-primary"><?php echo $button_upload; ?></a>
                  <?php if ($error_filename) { ?>
                  <span class="error"><?php echo $error_filename; ?></span>
                  <?php } ?> 
                  <br/>
                  <br/>
                  <a href="javascript:;" onclick="$('#action').val('get_template');$('#form').submit();" class="button btn btn-primary"><?php echo $this->language->get("text_get_template");?></a>
                </td>
              </tr>
