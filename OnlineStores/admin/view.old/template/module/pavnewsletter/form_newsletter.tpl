...
<div id="content">
  ...
  <?php } ?>
  <div class="box" style="min-height: 2200px;">
    ...
    <div class="right-panel">
      ...
      <div class="toolbar"><?php $menu_active="create_newsletter"; require( DIR_TEMPLATE.'module/pavnewsletter/action_bar.tpl' ); ?></div>
    <div class="content">
      ...
      <tbody id="defined-product">
        ...
        <?php foreach ($defined_products_more as $index => $dpm) { ?>
          <tr>
          <td><?php echo $entry_section_name; ?></td>
          <td><input type="text" size="60" name="defined_product_more[<?php echo $index; ?>][text]" value="<?php echo $dpm['text']; ?>" /> <a onclick="removeSection(this);" class="button btn btn-primary"><span><?php echo $button_remove; ?></span></a></td>
          </tr>
          <tr>
          <td><?php echo $entry_product; ?></td>
        ...
        <tr>
          <td></td>
          <td class="left"><a onclick="addDefinedSection();" class="button btn btn-primary" style="display:none;"><span><?php echo $button_add_defined_section; ?></span></a></td>
        </tr>
      </tbody>
      <tr>
      ...
      <tr>
        ...
        <td>
          <table id="attachment">
            ...
            <tfoot>
              <tr>
                <td class="left"><a onclick="addFile();" class="button btn btn-primary"><span><?php echo $button_add_file; ?></span></a></td>
                <td></td>
              </tr>
            </tfoot>
          </table>
...
<script type="text/javascript"><!-- 
  $(document).ready(function() {
    ...
    $(document).on('click', '#defined_product div img', function() {
      $(this).parent().remove();
      $('#defined_product div:odd').attr('class', 'odd');
      $('#defined_product div:even').attr('class', 'even');
    ...
    $(document).on('click', "[id^='defined_product_'].scrollbox div img", function() {
      $(this).parent().remove();
  ...
  $('input[name^=\'defined_products_\']').autocomplete({
    ...
    function addDefinedSection() {
      ...
      html += '<td><input type="text" size="60" name="defined_product_more[' + defined_section_row + '][text]" value="" /> <a onclick="removeSection(this);" class="button btn btn-primary"><span><?php echo $button_remove; ?></span></a></td>';
      html += '</tr>';
      html += '<tr>';
