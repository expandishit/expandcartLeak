			...
			<div class="heading">
			  <h1><?php echo $heading_title; ?></h1>
				<div class="buttons">
				 ...
				 <a onclick="__submit('published')" class="button btn btn-primary"><?php echo $this->language->get("button_publish"); ?></a>
				 <a onclick="__submit('unpublished')" class="button btn btn-primary"><?php echo $this->language->get("button_unpublish"); ?></a>
						...
						<table class="table table-hover dataTable no-footer">
							<thead>
								<tr>
									...
									<td class="center" width="200"><?php echo $this->language->get('text_position');?> <a onclick="__submit('position')" class="button btn btn-primary"><?php echo $this->language->get("Save"); ?></a></td>
