                          ...
                          <td><select name="pavtwitter_module[<?php echo $module_row; ?>][theme]">
                              <?php foreach($themes as $theme):?>
                                <?php if(isset($module['theme']) && $module['theme'] == $theme):?>
                                  <option value="<?php echo $theme; ?>" selected="selected"><?php echo $this->language->get($theme); ?></option>
                              <?php else: ?>
                                  <option value="<?php echo $theme; ?>"><?php echo $this->language->get($theme); ?></option>
                               <?php endif;?>
                              <?php endforeach; ?>
                          </select> 
                        </tr>
                          ...
                          <td><select name="pavtwitter_module[<?php echo $module_row; ?>][chrome][]" multiple="multiple">
                              <?php foreach($chromes as $chrome):?>
                                <?php if(isset($module['chrome']) && is_array($module['chrome']) && in_array($chrome, $module['chrome'])):?>
                                  <option value="<?php echo $chrome; ?>" selected="selected"><?php echo $this->language->get($chrome); ?></option>
                              <?php else: ?>
                                  <option value="<?php echo $chrome; ?>"><?php echo $this->language->get($chrome); ?></option>
                               <?php endif;?>
                              <?php endforeach; ?>
