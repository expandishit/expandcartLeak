          ...
          <table class="form">
			...
			<tr>
			  ...
			  <select name="pavfacebook_module[<?php echo $module_row; ?>][colorscheme]">
                  ...
                  <option value="dark" selected="selected"><?php echo $this->language->get("Dark"); ?></option>
                  <option value="light"><?php echo $this->language->get("Light"); ?></option>
                  <?php } else { ?>
                 <option value="dark" ><?php echo $this->language->get("Dark"); ?></option>
                  <option value="light" selected="selected"><?php echo $this->language->get("Light"); ?></option>
                  <?php } ?>
                </select>
