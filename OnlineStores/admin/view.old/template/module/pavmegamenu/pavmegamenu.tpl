...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
	  ...
	  <a href="<?php echo $liveedit_url; ?>" class="button btn btn-primary" style="background:#5CB85C"><?php echo $this->language->get('text_live_edit'); ?></a>
	  <a href="<?php echo $cancel; ?>" class="button btn btn-primary"><?php echo $button_cancel; ?></a> |
	   
	   
	  <a class="button btn btn-primary" style="background:#49AFCD" id="btn-guide" href="https://www.expandcart.com/guides/expandcart/"><?php echo $this->language->get('Guide');?></a>
	</div>
    	 ...
    	 <div id="tab-contents">
	 		...
	 		<div id="tab-manage-menus">				
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
						...
						<a onclick="__submit('import-categories')" class="button btn btn-primary"><?php echo $this->language->get('button_import_categories'); ?></a>
						<a onclick="__import('delete-categories')" class="button btn btn-primary"><?php echo $this->language->get('button_delete_categories'); ?></a>
					</div>
					<div class="megamenu">
