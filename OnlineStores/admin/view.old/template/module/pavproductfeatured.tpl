  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
        ...
        <a onclick="$('#frmaction').val('save-edit');$('#form').submit();" class="button btn btn-primary"><?php echo $this->language->get('text_save_edit'); ?></a>
    ...
    <div class="content">
     ...
     <table class="form" style="padding-top:12px">
      <tr>
      ...
      <tr>
        ...
        <td><div id="featured-product<?php echo $module_row; ?>" class="scrollbox">
            ...
            <div id="featured-product<?php echo $module_row;?>-<?php echo $product['product_id']; ?>" class="<?php echo $class; ?>"><?php echo $product['name']; ?> <i class="fa fa-times"></i>
...
function productAutocomplete(module_id){
  ...
  select: function(event, ui) {
    ...
    $('#featured-product'+module_id).append('<div id="featured-product' +module_id + '-' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#featured-product'+module_id+' div i', function() {
  $(this).parent().remove();
