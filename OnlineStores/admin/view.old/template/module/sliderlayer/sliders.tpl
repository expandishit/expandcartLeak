  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons pull-right">
      			<a onclick="$('#form').submit();" class="btn btn-primary"><?php echo $this->language->get('Save All And Edit Group'); ?></a>
      			<a onclick="$('#action_mode').val('create-new');$('#form').submit();" class="btn btn-primary"><?php echo $this->language->get('Save All And Create New Group'); ?></a>
      			<a onclick="$('#action_mode').val('module-only');$('#form').submit();" class="btn btn-primary"><?php echo $this->language->get('Save Modules Only'); ?></a>
    ...
    <div class="page-content">
					          ...
					          <tbody id="module-row<?php echo $module_row; ?>">
					            <tr>
					              ...
					              <td class="left"><select name="pavsliderlayer_module[<?php echo $module_row; ?>][position]">
					                  ...
					                  <option value="mainmenu" selected="selected"><?php echo $this->language->get("Main Menu");?></option>
					                  <?php } else { ?>
					                  <option value="mainmenu"><?php echo $this->language->get("Main Menu");?></option>
					                  <?php } ?>
									  
									  <?php if ($module['position'] == 'slideshow') { ?>
					                  <option value="slideshow" selected="selected"><?php echo $this->language->get("Slideshow");?></option>
					                  <?php } else { ?>
					                  <option value="slideshow"><?php echo $this->language->get("Slideshow");?></option>
					                  <?php } ?>
									  
									  <?php if ($module['position'] == 'promotion') { ?>
					                  <option value="promotion" selected="selected"><?php echo $this->language->get("Promotion");?></option>
					                  <?php } else { ?>
					                  <option value="promotion"><?php echo $this->language->get("Promotion");?></option>
					                  <?php } ?>
									  
									  <?php if ($module['position'] == 'footer_top') { ?>
					                  <option value="footer_top" selected="selected"><?php echo $this->language->get("Footer Top");?></option>
					                  <?php } else { ?>
					                  <option value="footer_top"><?php echo $this->language->get("Footer Top");?></option>
					                  <?php } ?>
									  
									  <?php if ($module['position'] == 'footer_center') { ?>
					                  <option value="footer_center" selected="selected"><?php echo $this->language->get("Footer Center");?></option>
					                  <?php } else { ?>
					                  <option value="footer_center"><?php echo $this->language->get("Footer Center");?></option>
					                  <?php } ?>
									  
									  <?php if ($module['position'] == 'footer_bottom') { ?>
					                  <option value="footer_bottom" selected="selected"><?php echo $this->language->get("Footer Bottom");?></option>
					                  <?php } else { ?>
					                  <option value="footer_bottom"><?php echo $this->language->get("Footer Bottom");?></option>
					                  <?php } ?>
     ...
     <div id="tab-slidergroups">
		...
		<div class="groups">
				...
				<ul>
					...
					<a <?php if( $sgroup['id'] == $id ) { ?> class="active" <?php } ?> href="<?php echo $this->url->link('module/pavsliderlayer', 'id='.$sgroup['id'].'&token=' . $this->session->data['token'], 'SSL');?>"><?php echo $sgroup['title'];?>
						<span>(<?php echo $this->language->get('ID');?>:<?php echo $sgroup['id'];?>)</span>
					</a> 
		...
		<div class="group-form">
			...
			<table class="form">
				<tr>
					<td><?php echo $this->language->get('ID');?>: <?php echo $id;?>
					...
					<td>
						...
						<div class="buttons">
							...
							<a id="btn-preview-ingroup" href="<?php echo  $this->url->link('module/pavsliderlayer/preview', 'id='.$id.'&token=' . $this->session->data['token'], 'SSL');?>" class="btn btn-primary" id="preview"><?php echo $this->language->get('Preview Sliders In Group');?></a>

							<a href="<?php echo  $this->url->link('module/pavsliderlayer/layer', 'group_id='.$id.'&token=' . $this->session->data['token'], 'SSL');?>" class="btn btn-primary" id="preview-sliders"><?php echo $this->language->get('Manages Sliders'); ?></a>

							<a href="<?php echo  $this->url->link('module/pavsliderlayer/delete', 'id='.$id.'&token=' . $this->session->data['token'], 'SSL');?>" onclick="return confirm('Are you sure to delete this');" class="btn btn-primary" id="preview-sliders">
								<?php echo $this->language->get('Delete'); ?>
							</a>


							<a href="<?php echo  $this->url->link('module/pavsliderlayer/export', 'id='.$id.'&token=' . $this->session->data['token'], 'SSL');?>"  class="btn btn-primary" id="preview-sliders">
				...
				<tr>
					...
					<td>
				 		<select name="slider[fullwidth]">
							...
							<option value="<?php echo $key;?>" <?php if( isset($params['fullwidth']) && ($key == $params['fullwidth']) ){ ?> selected="selected" <?php } ?> ><?php echo $this->language->get($value); ?></option>
							 <?php } ?>
			...
			<table class="form">
				...
				<tr>
					<td><?php echo $this->language->get('Time Liner Position');?></td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="slider[margin]" value="<?php echo $params['margin'];?>"/> <?php echo $this->language->get('Example');?>: 5px 0; <?php echo $this->language->get('or');?> 5px 10px 20px
				...
				<tr>
					...
					<td>
						<input type="text" name="slider[padding]" value="<?php echo $params['padding'];?>"/> <?php echo $this->language->get('Example');?>: 5px 0; <?php echo $this->language->get('or');?> 5px 10px 20px
