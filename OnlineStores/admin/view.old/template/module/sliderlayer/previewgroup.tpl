...
?>
<div class="bannercontainer" style="padding: <?php echo $sliderParams['padding'];?>; max-width:<?php echo $sliderParams['width'];?>px;">
										...
										<div class="caption <?php echo $layer['layer_class']; ?> <?php echo $layer['layer_animation'];?> 
											...
											<?php echo $layer['layer_endanimation'];?>"
											 ...
											 data-easing="easeOutExpo" <?php echo $endeffect;?> >
											 	<?php if( $type=='image') { ?> 
											 	<img src="<?php echo HTTP_IMAGE.$layer['layer_content'];?>">
