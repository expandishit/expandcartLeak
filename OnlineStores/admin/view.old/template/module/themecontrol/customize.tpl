...
<form  enctype="multipart/form-data" action="<?php echo $action; ?>" id="form" method="post">
	<div class="pav-customize" id="pav-customize">
		<div class="btn-show"><?php echo $this->language->get('text_customize');?></div>
        <div class="btn-back-cust">
            <a href="<?php echo $back_url;?>" class="pull-right"><?php echo $this->language->get('text_back');?></a>
        </div>
        <br>
        <hr>
		<div class="wrapper">	
...
$(document).ready( function() {
	var url  = '<?php echo $customizeFolderURL; ?>'+"clientcustomstyle.json?rand"+Math.random();
	...
	_link.attr('href', '<?php echo $customizeFolderURL?>'+"clientcustomstyle.css?rand="+Math.random() );
