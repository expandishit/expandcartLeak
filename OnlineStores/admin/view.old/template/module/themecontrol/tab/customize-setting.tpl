...
<script>
    var notificationString = "<?php echo implode(', ', $warning_custom_files_permission); ?>";
...
<table class="form">
		...
		<tr>
			<td colspan="2">
				...
				<select name="themecontrol[customize_theme]" style="display:none;">
				...
				<a href="<?php echo $live_customizing_url;?>" class="button btn btn-primary"><?php echo $this->language->get('text_live_edit');?></a>
			</td>
		</tr>
...
<textarea name="themecontrol[custom_css]" rows="16" style="width: 100%;"><?php echo $module['custom_css'];?></textarea>
</td>
</tr>
<tr><td>
...
<textarea name="themecontrol[custom_javascript]" rows="16" style="width: 100%;"><?php echo $module['custom_javascript'];?></textarea>
</td></tr>
</table>