	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons">
				...
				<a onclick="$('#action').val('save-edit');$('#form').submit();" class="button btn btn-primary"><?php echo $this->language->get('text_save_edit'); ?></a>
					...
					<table class="form">
						...
						<tr>
							...
							<td><select name="pavpopulartags_module[<?php echo $module_row; ?>][font_weight]">
								...
								<option value="<?php echo $font; ?>" selected="selected"><?php echo $this->language->get($font); ?></option>
								<?php } else { ?>
								<option value="<?php echo $font; ?>"><?php echo $this->language->get($font); ?></option>
								<?php } ?>
								<?php } ?>
								</select>
							</td>
