  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<h3><?php echo $this->language->get('List of Banner Images'); ?></h3>
        <div class="vtabs">
	...
	// 	  echo '<pre>'.print_r( $banner_image,1 ); die; 
        ...
        <div id="tab-module-<?php echo $banner_row; ?>" class="vtabs-content">
		 ...
		 <table class="form">
			 ...
			 <!--<tr>
				<td><?php echo $this->language->get('Image'); ?></td>
          ...
          <div id="tab-language-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
				...
				<tr>
					<td><?php echo $this->language->get('Image'); ?></td>
					<td class="left"><div class="image"><img src="<?php echo $banner['thumb'][$language['language_id']]; ?>" alt="" id="thumb-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>" />
							<input type="hidden" name="banner_image[<?php echo $banner_row; ?>][image][<?php echo $language['language_id']; ?>]" value="<?php echo $banner['image'][$language['language_id']]; ?>" id="image-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>"  />
							<br />
							<a onclick="image_upload('image-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>', 'thumb-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
