...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <a onclick="$('#action-mode').val('save-keep');$('#form').submit();" class="button btn btn-primary"><?php echo $this->language->get('button_save_keep'); ?></a>
    ...
    <div class="category-tabs">
      ...
      <div class="box-head">
         <a class="button btn btn-primary" id="add-cattab" onclick="addCategoryTab('category-tabs<?php echo $module_row; ?>',<?php echo $module_row;?>)"><?php echo $this->language->get('text_add_category');?></a>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <select name="pavproducts_module[<?php echo $module_row;?>][category_tabs][]">
                     ...
                     <option <?php if( $module['category_tabs'][$idx] == $category['category_id'] ) {?>selected="selected"<?php } ?> value="<?php echo $category['category_id'];?>"><?php echo addslashes($category['name']);?> [<?php echo $text_id; ?>:<?php echo $category['category_id'];?>]</option>
                     <?php } ?>
                     </select>
                  </td>
                 ...
                 <a onclick="image_upload('image<?php echo $imgidx; ?>', 'thumb<?php echo $imgidx; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb<?php echo $imgidx; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $imgidx; ?>').attr('value', '');"><?php echo $text_clear; ?></a>
                  ...
                  <td style="display: none;"><?php echo $this->language->get('entry_addition_class');?></td>
...
<script type="text/javascript">
  ...
  function addCategoryTab( wrapper,mid ){
    ...
    var html  = '';
     ...
     <?php foreach( $product_categories as $category){ ?>
      html +='<option value="<?php echo $category['category_id'];?>"><?php echo addslashes($category['name']);?> [<?php echo $text_id; ?>:<?php echo $category['category_id'];?>]</option>';
     <?php } ?>
     html += '</select>';
     html += '</td>';
...
function addModule() {	
  ...
  html +=       '<a class="button btn btn-primary" id="add-cattab" onclick="addCategoryTab(\'category-tabs'+module_row+'\','+module_row+')"><?php echo $this->language->get('text_add_category');?></a>';
  html += '   </div>';
