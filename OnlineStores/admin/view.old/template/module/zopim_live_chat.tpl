...
<ol class="breadcrumb">
    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons">
                <a onclick="$('#form').submit();" class="button btn btn-primary"><span><?php echo $button_save; ?>
                    </span> </a><a onclick="location = '<?php echo $cancel; ?>';"
                               class="button btn btn-primary"><span><?php echo $button_cancel; ?> </span> </a>
            </div>
        </div>
        ...
        <div class="content">
                ...
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="zopim_usessl" value="true"
                            ...
                            <?php echo $text_SSL_uncheck_help; ?></td>
                    </tr>
                    <tr>
                        <td><a href="<?php echo $zopimDashboard; ?>" target="_blank"><?php echo $text_zopim_dashboard; ?></a><br /></td>
                        <td>
                            <strong><?php echo $zopim_accountDetails; ?></strong><br />
                            <?php echo $text_zopim_dash_help2; ?>
                        </td>
                    </tr>
                    <tr>
            ...
            <?php if (isset($text_zopim_dashboard) && !empty($text_zopim_dashboard) && strpos($text_zopim_dashboard, 'Lite') !== false) : ?>
                <tr>
                    <td colspan="2">
                        <strong><?php echo $text_theme_setting; ?> </strong>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="hidden" id="zopim_color" name="zopim_color"
                        ...
                        <div
                            ...
                            echo "<br><span style='cursor: pointer; color: #ff8;' onclick=\"e.preventDefault(); document.getElementById('zopim_color').value=''; updateWidget();\">Restore default color</span></div>";
                            ?>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="zopim_theme" id="zopim_theme"
                                onchange="updateWidget()">
                            <?php foreach ($zopimThemes as $theme) { ?>
                            <option value="<?php echo $theme;?>"
                                <?prcalc hp if($zopim_theme==$theme) echo 'selected="selected"';?>>
                                <?php echo $theme;?>
                            </option>
                            <?php } ?>
                        </select>
...
<table id="module" class="table table-hover dataTable no-footer">
    <thead>
        <tr>
            ...
            <td class="left" style="display: none;"><?php echo $entry_position; ?></td>
    ...
    <tbody id="module-row<?php echo $module_row; ?>">
        <tr>
            ...
            <td class="left" style="display: none;"><select
            ...
            <td class="left"><a
                    ...
                    class="button btn btn-primary"><span><?php echo $button_remove; ?> </span> </a>
            </td>
        </tr>
    </tbody>
    <?php $module_row++; ?>
    ...
    <tfoot>
        <tr>
            <td colspan="4"></td>
            <td class="left"><a onclick="addModule();" class="button btn btn-primary"><span><?php echo $button_add_module; ?>
                    </span> </a></td>
        </tr>
    </tfoot>
</table>
...
<script type="text/javascript">
    ...
    _.push(o)};z._=[];z.set._=[];$.async=!0;$.setAttribute("charset","utf-8");
            $.src="https://v2.zopim.com/?<?php echo $zopim_code; ?>";z.t=+new Date;$.
...
<?php } ?>
html += '    </select></td>';
html += '    <td class="left" style="display: none;"><select name="zopim_live_chat_module[' + module_row + '][position]">';
...
html += '    <td class="left"><a onclick="$(\'#module-row' + module_row + '\').remove();" class="button btn btn-primary"><span><?php echo $button_remove; ?></span></a></td>';
html += '  </tr>';
html += '</tbody>';
