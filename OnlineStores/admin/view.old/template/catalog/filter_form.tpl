  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <table id="filter" class="table table-hover dataTable no-footer">
          <thead>
            <tr>
          ...
          <tbody id="filter-row<?php echo $filter_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#filter-row<?php echo $filter_row; ?>').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $filter_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addFilter();" class="button btn btn-primary"><?php echo $button_add_filter; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addFilter() {
	...
	html += '     <td class="left"><a onclick="$(\'#filter-row' + filter_row + '\').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
