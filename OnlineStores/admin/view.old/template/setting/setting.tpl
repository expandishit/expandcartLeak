<?php include_jsfile($header, $footer, 'view/template/setting/setting.tpl.js'); ?>

<script>
    var selLang = '<?php echo $direction; ?>';
    var guidestate = '<?php echo $guidestate; ?>';
...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a name="config_save" onclick="$('#form').submit();" class="button btn btn-primary"><?php echo $button_save; ?></a></div>
    </div>
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-local">
          <table class="form">
            ...
            <tr>
              <td><?= $entry_timezone ?></td>
              <td>
                <select name="config_timezone">
                  <?php foreach($timezones as $key => $value) : ?>
                    <option value="<?= $key ?>" <?php if ($config_timezone == $key) echo 'selected="selected"';?>> 
                      <?= $value ?> 
                    </option>
                  <?php endforeach ?>
                </select>
        ...
        <div id="tab-option">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <tr>
                  <td>
                      <?php echo $text_show_brands; ?>
                      <br />
                      <span class="help"><?php echo $text_show_brands_desc; ?></span>
                  </td>
                  <td>
                      <input type="radio" name="show_brands" value="1" <?php echo (($show_brands == 1) ? 'checked="checked"' : '') ?> />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="show_brands" value="0" <?php echo (($show_brands == 0) ? 'checked="checked"' : '') ?> />
                      <?php echo $text_no; ?>
                  </td>
              </tr>
          </table>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <tr>
                  <td><?php echo $entry_externalorder; ?></td>
                  <td><?php if ($config_externalorder) { ?>
                      <input type="radio" name="config_externalorder" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_externalorder" value="0" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_externalorder" value="1" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_externalorder" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } ?></td>
              </tr>
          </table>
          ...
          <table class="form">
            <tr>
              ...
              <tr>
                  <td><?php echo $entry_order_popup; ?></td>
                  <td><?php if ($config_order_popup) { ?>
                      <input type="radio" name="config_order_popup" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_order_popup" value="0" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_order_popup" value="1" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_order_popup" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } ?></td>
              </tr>
            <tr>
            ...
            <!--
              ...
              // 26 - 12 - 2017
              // Add the invoice image product settings
            -->
            <tr>
 <td><?php echo $invoice_image_product_appear; ?></td>
              <td><?php if ($invoice_image_product) { ?>
                <input type="radio" name="invoice_image_product" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="invoice_image_product" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="invoice_image_product" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="invoice_image_product" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            ...
            <tr>
              ...
              <tr>
                  <td><?php echo $entry_order_cod_status; ?></td>
                  <td><select name="config_order_cod_status_id">
                          <?php foreach ($order_statuses as $order_status) { ?>
                          <?php if ($order_status['order_status_id'] == $config_order_cod_status_id) { ?>
                          <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                          <?php } ?>
            ...
            <tr>
              ...
              <tr>
                  ...
                  <td><input type="text" name="config_webhook_url" value="<?php echo $config_webhook_url; ?>" /></td>
              </tr>
          </table>
          ...
          <table class="form">
            ...
            <tr>
              <td><?= $entry_stock_status_display_badge; ?></td>
              <td><div class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($stock_statuses as $stock_status) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div class="<?= $class; ?>">
                    <?php if (in_array($stock_status['stock_status_id'], $this->config->get('config_stock_status_display_badge'))) { ?>
                    <input type="checkbox" name="config_stock_status_display_badge[]" value="<?php echo $stock_status['stock_status_id']; ?>" checked="checked" />
                    <?php echo $stock_status['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="config_stock_status_display_badge[]" value="<?php echo $stock_status['stock_status_id']; ?>" />
                    <?php echo $stock_status['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
          ...
          <table class="form">
            <tr>
              ...
              <td><div class="image"><img src="<?php echo $logo; ?>" alt="" id="thumb-logo" />
                  <input type="hidden" name="config_logo" value="<?php echo $config_logo; ?>" id="logo-image" />
                  <br />
                  <a name="config_logo_browse" onclick="image_upload('logo-image', 'thumb-logo');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-logo').attr('src', '<?php echo $no_image; ?>'); $('#logo-image').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><?php echo $entry_logo_size; ?></td>
              <td><input type="text" name="config_image_logo_height" value="<?php echo $config_image_logo_height; ?>" size="3" /></td>
            </tr>
              <tr>
                  <td><?php echo $entry_show_manfacture_image; ?></td>
                  <td><?php if ($config_show_manfacture_image) { ?>
                      <input type="radio" name="config_show_manfacture_image" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_show_manfacture_image" value="0" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_show_manfacture_image" value="1" />
                      <?php echo $text_yes; ?>
                      <input type="radio" name="config_show_manfacture_image" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } ?></td>
              </tr>
          </table>
        ...
        <div id="tab-server" style="display: none;">
            <table class="form">
                ...
                <tr>
                    <td><?php echo $entry_header_scripts; ?></td>
                    <td><textarea name="config_google_analytics" cols="40" rows="5"><?php echo $config_google_analytics; ?></textarea></td>
                </tr>
                <tr>
                    <td><?php echo $entry_body_scripts; ?></td>
                    <td><textarea name="config_body_scripts" cols="40" rows="5"><?php echo $config_body_scripts; ?></textarea></td>
                </tr>
            </table>
        </div>
      </form>
