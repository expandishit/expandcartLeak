...
<ol class="breadcrumb">
	...
	<div class="box">
	<div class="heading">
		<h1><?php echo isset($seller['seller_id']) ? $ms_catalog_sellerinfo_heading : $ms_catalog_sellers_newseller; ?></h1>
		<div class="buttons"><a id="ms-submit-button" class="button btn btn-primary"><?php echo $button_save; ?></a></div>
	</div>
	<div class="content">
	<form id="ms-sellerinfo">
		...
		<div id="tabs" class="htabs">
			...
			<?php if ($subscription_system_status == 1) { ?>
			<a href="#tab-subscriptions">{{ lang('ms_subscription_list') }}</a>
			<?php } ?>
		</div>
		<div id="tab-general">
		...
		<tr>
			...
			<td>
				<div id="sellerinfo_avatar_files">
					...
					<input type="hidden" name="seller[tmp_avatar_name]" value="<?php echo $seller['avatar']['name']; ?>" />
					<img src="<?php echo $seller['avatar']['thumb']; ?>" />
					<?php } ?>
				</div>
				<div>
					<a name="ms-file-selleravatar" id="ms-file-selleravatar" class="btn btn-primary"><span>{{ lang('ms_button_select_image') }}</span></a>
				</div>
			</td>
		</tr>
		...
		<div id="tab-subscriptions">
			<table class="plansList table table-hover" id="plans_list">
				...
				<tbody>
				<?php foreach ($subscriptions_plans as $plan) { ?>
				<tr>
					<td><?= $plan['title']; ?></td>
