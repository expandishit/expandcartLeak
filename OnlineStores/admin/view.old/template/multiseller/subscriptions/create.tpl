...
<div id="content">
    ...
    <div class="box">
        ...
        <form id="newPlanForm" method="post" action="<?= $createPlan; ?>">
            <div>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name='ms_plan[plans][status]'>
                                ...
                                <option value='2'>{{ lang('text_disabled') }}</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td>{{ lang('ms_plan_price') }}</td>
                        <td><input type="text" name="ms_plan[plans][price]" /></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="ms_plan[plans][format]">
                                ...
                                <option value="2">{{ lang('month') }}</option>
            ...
            <div id="language<?php echo $language['language_id']; ?>">
                <table class="form table">
                    <tr>
                        ...
                        <td><input type="text" name="ms_plan[details][<?= $language['language_id']; ?>][title]" /></td>
                    </tr>
                    <tr>
                        <td>{{ lang('ms_plan_description') }}</td>
                        <td><textarea name="ms_plan[details][<?= $language['language_id']; ?>][description]"></textarea></td>
                    </tr>
                </table>
            </div>
            <?php } ?>
            <input type="hidden" name="ms_plan[actionType]" value="create" />
        </form>
    </div>
</div>
<script>
