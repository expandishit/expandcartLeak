	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons">
				...
				<a class="button btn btn-primary" href="<?php echo $link; ?>">Update DB to version <?php echo $v; ?></a>
				<?php } ?>
				<?php } ?>
				<a class="button btn btn-primary" id="saveSettings"><?php echo $button_save; ?></a>
	  	...
	  	<div class="content">
			<form id="settings" method="post" enctype="multipart/form-data">
			 	<div id="tabs" class="htabs">
					...
					<a href="#tab-subscriptions">{{ lang('ms_config_subscriptions_plans') }}</a>
			 	</div>
				...
				<table class="form">
					...
					<tr>
						<td>
							<span><?php echo $config_choose_payment; ?></span>
							<span class="help"><?php echo $congif_choose_payement; ?></span>
						</td>
						<td>
							<select name="config_choose_payement">
								<option value="1" <?php if($config_choose_payement == 1) { ?> selected="selected" <?php } ?>><?php echo $config_choose_payment_paypal; ?></option>
								...
								<option value="2" <?php if($config_choose_payement == 2) { ?> selected="selected" <?php } ?>><?php echo $config_choose_payment_credit; ?></option>
							</select>
						</td>
					</tr>
					...
					<tr>
						<td>
							<span>{{ lang('ms_config_enable_search_by_city') }}</span>
							<span class="help">{{ lang('ms_config_enable_search_by_city_note') }}</span>
						</td>
						<td>
							<select name="msconf_search_by_city">
								<option value="1" <?= ($msconf_search_by_city == 1) ? "selected" : '' ?> >{{ lang('text_enabled') }}</option>
								<option value="0" <?= ($msconf_search_by_city != 1) ? "selected" : '' ?> >{{ lang('text_disabled') }}</option>
							</select>
						</td>
					</tr>
				</table>
				...
				<table class="form">
					...
					<tr>
						<td>
							<span>{{ lang('ms_config_allow_download') }}</span>
							<span class="help">{{ lang('ms_config_allow_download_note') }}</span>
						</td>
						<td>
							<?php if ($config_download) { ?>
							<select name="msconfig_allow_download">
								<option value="1" <?= ($msconfig_allow_download == 1 ? 'selected' : ''); ?> >{{ lang('text_enabled') }}</option>
								<option value="0" <?= ($msconfig_allow_download != 1 ? 'selected' : ''); ?>>{{ lang('text_disabled') }}</option>
							</select>
							<?php } else { ?>
							<div class="ms_config_allow_download_error">
								<span>{{ lang('ms_config_allow_download_error') }}</span>
								<span class="help">{{ lang('ms_config_allow_download_error_note') }}</span>
							</div>
							<?php } ?>
						</td>
					</tr>
					...
					<tr>
						  ...
						  <td>
                              <span><?php echo $ms_config_minimum_product_price; ?></span><input type="text" name="msconf_images_limits[]" value="<?php echo $msconf_images_limits[0]; ?>" size="3" />
                              <span><?php echo $ms_config_maximum_product_price; ?></span><input type="text" name="msconf_images_limits[]" value="<?php echo $msconf_images_limits[1]; ?>" size="3" />
						  </td>
					</tr>
					...
					<tr>
						...
						<td>
                            <span><?php echo $ms_config_minimum_product_price; ?></span><input type="text" name="msconf_downloads_limits[]" value="<?php echo $msconf_downloads_limits[0]; ?>" size="3" />
                            <span><?php echo $ms_config_maximum_product_price; ?></span><input type="text" name="msconf_downloads_limits[]" value="<?php echo $msconf_downloads_limits[1]; ?>" size="3" />
						</td>
					</tr>
					...
					<tr>
						<td>
							<span><?php echo $ms_config_enable_min_quantities; ?></span>
							<span class="help"><?php echo $ms_config_enable_min_quantities_note; ?></span>
						</td>
						<td>
							<input type="radio" name="msconf_enable_min_quantities" value="1" <?php if($msconf_enable_min_quantities == 1) { ?> checked="checked" <?php } ?>  />
							<?php echo $text_yes; ?>
							<input type="radio" name="msconf_enable_min_quantities" value="0" <?php if($msconf_enable_min_quantities == 0) { ?> checked="checked" <?php } ?>  />
							<?php echo $text_no; ?>
						</td>
					</tr>
				...
				<div id="tab-subscriptions">
					<table class="form">
						<tr>
							<td>
								<span>{{ lang('ms_config_enable_subscriptions_plans_system') }}</span>
								<span class="help">{{ lang('ms_config_enable_subscriptions_plans_system_note') }}</span>
							</td>
							<td>
								<select name="msconf_enable_subscriptions_plans_system">
									<option value="1" <?= ($msconf_enable_subscriptions_plans_system == 1) ? "selected" : '' ?> >{{ lang('text_enabled') }}</option>
									<option value="0" <?= ($msconf_enable_subscriptions_plans_system != 1) ? "selected" : '' ?> >{{ lang('text_disabled') }}</option>
								</select>
							</td>
						</tr>
						<tr>
							<td>{{ lang('ms_config_subscriptions_paypal_email') }}</td>
							<td>
								<input name="msconf_subscriptions_paypal_email" value="<?= $msconf_subscriptions_paypal_email; ?>" />
							</td>
						</tr>
						<tr>
							<td>{{ lang('ms_config_subscriptions_bank_details') }}</td>
							<td>
								<textarea name="msconf_subscriptions_bank_details"><?= $msconf_subscriptions_bank_details; ?></textarea>
							</td>
						</tr>
					</table>
				</div>
...
$(function() {
    $(document).on("click", "#saveSettings", function() {
		$.ajax({
			...
			data: $('#settings', '#content').serialize(),
