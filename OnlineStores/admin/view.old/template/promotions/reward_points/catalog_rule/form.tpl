...
<?php } ?>
    <div class="box catalog-rules">
        <div class="heading">
            ...
            <div class="buttons">
                <a onclick="$('#apply_rule').val(1);$('#form').submit();" class="button btn btn-primary"><?php echo $this->language->get('button_save_and_apply'); ?></a>
                <a onclick="$('#form').submit();" class="button btn btn-primary"><?php echo $this->language->get('button_save'); ?></a>
                <a onclick="if(confirm('<?php echo $this->language->get("Are you sure want to delete this rule?"); ?>')) location.href = '<?php echo $this->url->link('promotions/reward_points/catalogCartRuleDelete', 'token=' . $this->session->data['token']."&rule_id=".(isset($this->request->get['rule_id']) ? $this->request->get['rule_id'] : 0), 'SSL');?>';" href="javascript:;" class="button btn btn-danger"><?php echo $this->language->get('button_delete'); ?></a>
        ...
        <div class="content">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                                    ...
                                    <span class="rule-param rule-param-new-child">
                                        <a href="javascript:void(0)" class="label"><img src="view/image/rewardpoints/rule_component_add.gif" class="rule-param-add v-middle" alt="" title="<?php echo $this->language->get('Add'); ?>"></a><span class="element">
                                            <select id="conditions__<?php echo $counter?>__new_child" name="rule[conditions][<?php echo $counter?>][new_child]" class="element-value-changer select">
                                                ...
                                                <optgroup label="<?php echo $this->language->get('text_product_option')?>">
                ...
                <div id="tab-rule-actions">
                    <div>
                        <div class="entry-head">
                            <h4><?php echo $this->language->get('tab_rule_actions_h4')?></h4>
                        </div>
                        <div id="rule_actions_fieldset">
                            <table class="form">
                                <tr>
                                    ...
                                    <td>
                                        <select id="rule_simple_action" name="actions" class="">
                                            ...
                                            <option value="2" <?php echo ($actions == "2" ? 'selected=="selected"' : '')?>><?php echo $this->language->get('Spend (Y) Get (X) Reward Points per item')?></option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
