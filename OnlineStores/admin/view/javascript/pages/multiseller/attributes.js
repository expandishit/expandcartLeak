...
$(document).ready(function () {
    ...
    table = $('#datatableGrid').DataTable({
        ...
        columns: [
            ...
            {
                data: 'name',
                arender: function (data, type, row) {
                    return `<a href='`+ links['update'] +`?attribute_id=${row['attribute_id']}'>${row['seller']}</a>`;
                }
            },
            {data: 'type'},
            {data: 'sort_order'},
        ...
        columnDefs: [
            ...
            /*{
                ...
                render: function (data, type, row) {
                    ...
                    return statusSwitch(row.attribute_id, status);
                }
            },*/
            {
                sortable: false,
                    ...
                    return `<ul class="icons-list pull-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href='`+ links['update'] +`?attribute_id=${row['attribute_id']}'><i class='icon-pencil7'></i> Edit</a></li>
                                    <li><a onclick="removeItem(this)" data-rowid="${row['attribute_id']}"><i class='icon-trash'></i> Delete</a></li>
                                </ul>
                            </li>
                        </ul>
                    `;
