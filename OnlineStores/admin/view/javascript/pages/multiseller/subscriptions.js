        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `<a href='`+ links['update'] +`?plan_id=${row['plan_id']}'>${data}</a>`;
                }
            },
            {data: 'plan_status'},
        ],
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    return statusSwitch(row.plan_id, status);
                }
            },
            {
                sortable: false,
                    ...
                    return `<ul class="icons-list pull-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href='`+ links['update'] +`?plan_id=${row['plan_id']}'><i class='icon-pencil7'></i> Edit</a></li>
                                    <li><a onclick="removeItem(this)" data-rowid="${row['plan_id']}"><i class='icon-trash'></i> Delete</a></li>
                                </ul>
                            </li>
                        </ul>
                    `;
...
function statusSwitch(id, status) {
    return (status ? locales['switch_text_enabled'] : locales['switch_text_disabled']);
