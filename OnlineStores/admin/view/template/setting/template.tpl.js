    ...
    $.ajax({
        ...
        success: function(json) {
            if (json.success == "true") {
                ...
                $(".project-box.bg-green-300").fadeIn("slow", function() {
                ...
                $("#" + templateName + " .thumbnail").fadeIn("slow", function() {
                    ...
                    $(this).find('.panel-heading').append('<div class="heading-elements"><ul class="icons-list"><li><a data-action="reload" data-popup="tooltip" data-toggle="modal" data-target="#modal-reset-def" tempname="aurora" data-original-title="' + text_reset_templ + '"></a></li></ul></div>');
