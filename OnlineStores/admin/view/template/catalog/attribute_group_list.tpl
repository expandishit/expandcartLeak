                ...
                <div class="main-box clearfix">
                    <div class="tabs-wrapper profile-tabs">
                        <ul class="nav nav-tabs">
                            <li><a href="<?php echo $productattr; ?>"><?php echo $text_attributes; ?></a></li>
                            <li class="active"><a href="#tab-attrgroup" data-toggle="tab"><?php echo $text_attrgroups; ?></a></li>
                        </ul>
                    </div>

                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="tab-attrgroup">
                            <div class="heading">
