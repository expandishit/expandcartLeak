  ...
  <div class="box">
    <div class="heading">
      <h1><?php echo $heading_title; ?></h1>
        <div class="buttons">
            <a onclick="$('#form').submit();" class="button btn btn-primary"><?php echo $button_save; ?></a><a onclick="sav_con()" class="button btn btn-primary"><span><?php echo $button_save_continue; ?></span></a><a onclick="location = '<?php echo $cancel; ?>';" class="button btn btn-primary"><?php echo $button_cancel; ?></a><?php if(isset($_GET['product_id'])) { ?><a target="_blank" href="<?= $this->fronturl->link('product/product', 'product_id=' . $_GET['product_id']); ?>" class="button btn btn-primary"><?php echo $text_preview; ?></a><?php } ?></div><script language="javascript">
            function sav_con(){
    ...
    <div class="content">
      <div id="tabs" class="htabs">
          ...
          <?php if (isset($price_per_meter) && $price_per_meter == true) { ?>
            <a href="#tab-price-meter"><?php echo $tab_price_per_meter; ?></a>
          <?php }?>
          <a href="#tab-links"><?php echo $tab_links; ?></a>
          <a href="#tab-attribute"><?php echo $tab_attribute; ?></a>
          <a href="#tab-option"><?php echo $tab_option; ?></a>
          <?php if($productsoptions_sku_status) { ?>
              <a href="#tab-variation-sku"><?php echo $tab_variation_sku; ?></a>
          <?php } ?>
          ...
          <?php if(isset($AuctionModuleActive) && $AuctionModuleActive == 1) { ?>
              <a href="#tab-auction"><?php echo $tab_auction; ?></a></div>
          <?php } ?>
          <?php if($pdModuleStatus == '1') { ?>
              <a href="#tab-product_designer">{{ lang('pd_heading_title') }}</a>
          <?php } ?>
          </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <?php if (isset($rental_products) && $rental_products == true) { ?>
            <tr>
                <td>{{ lang('entry_transaction_type') }}</td>
                <td>
                    <select name="transaction_type">
                        <option value="1" <?= ($transaction_type == 1 ? 'selected' : ''); ?>>{{ lang('text_for_sale') }}</option>
                        <option value="2" <?= ($transaction_type == 2 ? 'selected' : ''); ?>>{{ lang('text_for_rent') }}</option>
                    </select>
                </td>
            </tr>
            <?php } ?>
            <tr>
              ...
              <td><input type="text" name="price" value="<?php echo $price; ?>" /> <?= $defaultCurrency; ?></td>
            </tr>

            <?php if ($dedicatedDomains['status'] == true) { ?>
            <tr>
                <td>{{ lang('add_price_to_domain') }}</td>
                <td>
                    <div style="cursor: pointer;" id="newPriceForDomain"
                         data-translation="<?= $dedicatedDomains['translation']; ?>"
                         data-url="<?= $dedicatedDomains['link']; ?>"
                         data-domains="<?= $dedicatedDomains['jsonDomains']; ?>">+</div>
                    <div id="dedicatedDomainsPrices">
                        <?php foreach($dedicatedDomains['domainPrices'] as $key => $domain) { ?>
                        <div class="domainInputs" data-index="<?= $key; ?>">
                            {{ lang('dedicated_domain_name') }}
                            <select id="domainName" name="domainData[<?= $key; ?>][domain_id]" readonly="true">
                                <option data-currency="<?= $domain['currency']; ?>"
                                        value="<?= $domain['domain_id']; ?>"><?= $domain['domain']; ?></option>
                            </select>
                            {{ lang('dedicated_domain_price') }} <input type="text" id="domainPrice"
                                   value="<?= $domain['price']; ?>" name="domainData[<?= $key; ?>][price]" />
                            <span class="dedicatedCurrency dedicatedCurrency_<?= $key; ?>"><?= $domain['currency']; ?></span>
            ...
            <?php } ?>
            <tr>
              <td><?php echo $entry_cost_price; ?></td>
              <td><input type="text" name="cost_price" value="<?php echo $cost_price; ?>" /> <?= $defaultCurrency; ?></td>
            </tr>
            <tr>
        ...
        <?php 
        //price per meter
        if (isset($price_per_meter) && $price_per_meter == true) { ?>
        <div id="tab-price-meter">
          <table class="form">
            <tr>
              <td><strong><?php echo $entry_main_unit; ?></strong></td>
              <td>
                <?php echo $entry_enable; ?> <input type="checkbox" name="main_status" <?php echo $main_status == 1 ? 'checked':'' ?>/>
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_meter_price; ?></td>
              <td><input type="text" name="main_meter_price" value="<?php echo $main_meter_price; ?>" />
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_package_size; ?></td>
              <td><input type="text" name="main_package_size" value="<?php echo $main_package_size; ?>" /> 
            ...
            <tr>
              <td><?php echo $entry_price_percentage; ?></td>
              <td><input type="text" name="main_price_percentage" value="<?php echo $main_price_percentage; ?>" /> %
              </td>
            </tr>

            <tr>
              <td><strong><?php echo $entry_skirtings_unit; ?></strong></td>
              <td>
               <?php echo $entry_enable; ?> <input type="checkbox" name="skirtings_status" <?php echo $skirtings_status == 1 ? 'checked':'' ?>/>
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_meter_price; ?></td>
              <td><input type="text" name="skirtings_meter_price" value="<?php echo $skirtings_meter_price; ?>" />
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_package_size; ?></td>
              <td><input type="text" name="skirtings_package_size" value="<?php echo $skirtings_package_size; ?>" /> m/box
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_price_percentage; ?></td>
              <td><input type="text" name="skirtings_price_percentage" value="<?php echo $skirtings_price_percentage; ?>" /> %
              </td>
            </tr>

            <tr>
              <td><strong><?php echo $entry_metalprofile_unit; ?></strong></td>
              <td>
                <?php echo $entry_enable; ?> <input type="checkbox" name="metalprofile_status" <?php echo $metalprofile_status == 1 ? 'checked':'' ?>/>
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_meter_price; ?></td>
              <td><input type="text" name="metalprofile_meter_price" value="<?php echo $metalprofile_meter_price; ?>" />
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_package_size; ?></td>
              <td><input type="text" name="metalprofile_package_size" value="<?php echo $metalprofile_package_size; ?>" /> m/box
              </td>
            </tr>
            <tr>
              <td><?php echo $entry_price_percentage; ?></td>
              <td><input type="text" name="metalprofile_price_percentage" value="<?php echo $metalprofile_price_percentage; ?>" /> %
              </td>
            </tr>
          </table>
        </div>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <?php if ($dedicatedDomains['status']) { ?>
            <tr>
                <td>{{ lang('entry_domain') }}</td>
                <td>
                    <div class="scrollbox" id="product_domain">
                        <input type="checkbox" name="product_domain[]" value="0" class="alldomains" id="domain_0"
                               onclick="$('#product_domain .product_domain').prop('checked', $(this).is(':checked'))"
                        <?= (!$dedicatedDomains['productDomainsIds'] ? 'checked' : null); ?>
                        />
                        <label for="domain_0">{{ lang('all_domains') }}</label><br />
                        <?php foreach ($dedicatedDomains['domains'] as $domain) { ?>
                        <input type="checkbox" class="product_domain" name="product_domain[]"
                            ...
                            <?= (isset($dedicatedDomains['productDomainsIds'][$domain['domain_id']]) ? 'checked' : '') ?>
                            <?= (!$dedicatedDomains['productDomainsIds'] ? 'checked' : null); ?>
                        />
                        <label for="domain_<?= $domain['domain_id']; ?>"><?= $domain['domain']; ?></label><br />
                        <?php } ?>
                    </div>
                </td>
            </tr>
            ...
            <tr>
              ...
              <td><div id="product-category" class="scrollbox">
                  ...
                  <div id="product-category<?php echo $product_category['category_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_category['name']; ?><i class="fa fa-times"></i>
            ...
            <tr>
              ...
              <td><div id="product-filter" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-filter<?php echo $product_filter['filter_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_filter['name']; ?><i class="fa fa-times"></i>
            ...
            <tr>
              ...
              <td><div id="product-download" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-download<?php echo $product_download['download_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_download['name']; ?><i class="fa fa-times"></i>
            ...
            <tr>
              ...
              <td><div id="product-related" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-related<?php echo $product_related['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_related['name']; ?><i class="fa fa-times"></i>
                    <input type="hidden" name="product_related[]" value="<?php echo $product_related['product_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>
            <?php if($product_affiliate_link_status) { ?>
            <tr>
                <td><?php echo $entry_affiliate_link; ?></td>
                <td><input type="text" name="affiliate_link" value="<?php echo $affiliate_link; ?>" /></td>
            </tr>
            <?php } ?>
          </table>
        </div>
        <div id="tab-attribute">
          <table id="attribute" class="table table-hover dataTable no-footer">
            <thead>
              <tr>
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class="left"><a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addAttribute();" class="button btn btn-primary"><?php echo $button_add_attribute; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
      ...
      // Product Option Image PRO module <<
      if ($poip_installed) {
        $poip_html = "<td id=\"poip_settings_title\" style=\"display: none; vertical-align: top;\">";
        ...
        echo $poip_html;
            ...
            <table id="option-value<?php echo $option_row; ?>" class="table table-hover dataTable no-footer">
              <thead>
                <tr>
                  ...
                  <!-- Product Option Image PRO module << --><?php if ($poip_installed) { ?><td class="left" width="230"><?php echo $entry_image; ?></td><?php } ?><!-- >> Product Option Image PRO module -->
                  <td></td>
                </tr>
              </thead>
      ...
      ?>
              ...
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                    <!-- Product Option Image PRO module << --><?php if ($poip_installed) { ?><td></td><?php } ?><!-- >> Product Option Image PRO module -->
                  <td class="left"><a onclick="addOptionValue('<?php echo $option_row; ?>');" class="button btn btn-primary"><?php echo $button_add_option_value; ?></a></td>
                </tr>
              </tfoot>
            </table>
    ...
    <?php if($productsoptions_sku_status) { ?>
          <div id="tab-variation-sku">
              <input type="hidden" name="num_options" value="<?= count($optionsHeaders); ?>" />
              <table class="table table-hover dataTable no-footer">
                  <thead>
                  <tr>
                      <td>#</td>
                      <?php foreach ($optionsHeaders as $optionsHeader) { ?>
                      <td class="left"><?= $optionsHeader; ?></td>
                      <?php } ?>
                      <td>SKU</td>
                      <td>{{ lang('entry_quantity') }}</td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($optionsVariationValues as $key => $optionsVariationValue) { ?>
                  <?php $quantityError = false; ?>
                  <tr>
                      <td>#</td>
                      <?php foreach ($optionsVariationValue as $compinationKey => $combination) { ?>
                      <td>
                          <?php if (isset($combination['input']) && $combination['input'] == true) { ?>
                          <input type="hidden" name="product_options_variations[<?= $key; ?>][parent_id]"
                                 value="<?= $combination['id']; ?>" />
                          <?php if ($combination['name'] == 'quantity' && $quantityError == true) { ?>
                          <input type="text" name="product_options_variations[<?= $key; ?>][<?= $combination['name']; ?>]"
                          ...
                          <?php } else { ?>
                          <?= $combination['value']; ?>
                          <input type="hidden" name="product_options_variations[<?= $key; ?>][options][<?= $compinationKey; ?>]"
                                 value="<?= $combination['option_value_id']; ?>" />
                          <?php if (isset($errors['variation'][$combination['option_value_id']])) { ?>
                          <?php $quantityError = $errors['variation'][$combination['option_value_id']]; ?>
                          <?php } ?>
                          <?php } ?>
                      </td>
                      <?php } ?>
        ...
        <?php function sortByOrder($a, $b) {
    		return $a['option_value_id'] - $b['option_value_id'];
		}
		?>
    <?php } ?>
        <div id="tab-discount">
          <table id="discount" class="table table-hover dataTable no-footer">
            <thead>
              <tr>
                ...
                <?php if ($dedicatedDomains['status'] == true) { ?>
                <td class="left">{{ lang('domain_name') }}</td>
                <?php } ?>
                <td></td>
              </tr>
            </thead>
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <?php if ($dedicatedDomains['status'] == true) { ?>
                <td class="left">
                    <?= $product_discount['domain_name']; ?>
                    <input type="hidden" name="product_discount[<?= $discount_row; ?>][dedicated_domains]"
                           value="<?= $product_discount['dedicated_domains']; ?>" />
                </td>
                <?php } ?>
                <td class="left"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $discount_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="6"></td>
                <td class="left"><a onclick="addDiscount();" class="button btn btn-primary"><?php echo $button_add_discount; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="special" class="table table-hover dataTable no-footer">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <?php if ($dedicatedDomains['status'] == true) { ?>
                <td class="left">
                    <?= $product_special['domain_name']; ?>
                    <input type="hidden" name="product_special[<?= $special_row; ?>][dedicated_domains]"
                           value="<?= $product_special['dedicated_domains']; ?>" />
                </td>
                <?php } ?>
                <td class="left"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="5"></td>
                <td class="left"><a onclick="addSpecial();" class="button btn btn-primary"><?php echo $button_add_special; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        ...
        <?php if($queryAuctionModule->num_rows) { ?>
            ...
            <div id="tab-auction">
                <fieldset id="fieldset_1">
                    ...
                    <div class="margin-form">
                        ...
                        <?php } ?>
                            <label class="t" for="use_max_price_on"><strong><?php echo $entry_max; ?></strong></label><br>
                            <p class="preference_description"><?php echo $entry_max_desc; ?></p>
                    </div>
                    <div class="clear"></div>
                    <div class="small">
                        <span class="required">*</span><?php echo $this->language->get('auc_text_required'); ?>
                    </div>
                </fieldset>
                <br/>
                <fieldset id="fieldset_2">
                    <legend><?php echo $auction_settings; ?></legend>

                    <div class="margin-form">
                        <?php if($status_on){ ?>
                            <input type="checkbox" value="1" class="" id="status_on" name="status_on" checked="checked">
                        <?php } else{ ?>
                            <input type="checkbox" value="1" class="" id="status_on" name="status_on" >
                        <?php } ?>
                        <label class="t" for="status_on"><strong><?php echo $auction_status; ?></strong></label><br/>
                    </div>
                    <div class="clear"></div>
                    <label><?php echo $auction_start; ?></label>
                    <div class="margin-form">
                        <input type="text" maxlength="10" size="20" class="datetime" value="<?php echo $start_time; ?>" id="start_time" name="start_time">
                        <span class="required">*</span><p class="preference_description"><?php echo $auction_start_desc; ?></p>
                        <?php if ($error_start) { ?>
                            <span class="error"><?php echo $error_start; ?></span>
                        <?php } ?>
                    </div>
                    <div class="clear"></div>
                    <label><?php echo $auction_end; ?></label>
                    <div class="margin-form">
                        <input type="text" maxlength="10" size="20" class="datetime" value="<?php echo $end_time; ?>" id="end_time" name="end_time">
                        <span class="required">*</span><p class="preference_description"><?php echo $auction_end_desc; ?></p>
                    ...
                    <div class="margin-form">
                        <input type="text" maxlength="10" size="20" name="start_price" value="<?php echo $start_price; ?>">
                        <span class="required">*</span><p class="preference_description"><?php echo $auction_starting_desc;?></p>

                        <?php if ($error_bid_price) { ?>
                            <span class="error"><?php echo $error_bid_price; ?></span>
                        <?php } ?>
                    </div>
                    <div class="clear"></div>
                    <label><?php echo $auction_max; ?></label>
                    <div class="margin-form">
                        <input type="text" maxlength="10" size="20" name="max_price" value="<?php echo $max_price; ?>">
                        <p class="preference_description"><?php echo $auction_max_desc; ?></p>

                        <?php if ($error_max_price) { ?>
                            <span class="error"><?php echo $error_max_price; ?></span>
                        <?php } ?>
                    </div>
                    <div class="clear"></div>
                    <label><?php echo $auction_min; ?></label>
                    <div class="margin-form">
                        <input type="text" maxlength="10" size="20" name="min_offer_step" value="<?php echo $min_offer_step; ?>">
                        <p class="preference_description"><?php echo $auction_min_desc; ?></p>
                    </div>
                    <div class="clear"></div>
                </fieldset>
            </div>
        <?php } ?>
        <?php if($pdModuleStatus == '1') { ?>
        <div id="tab-product_designer">
            <table class="form">
              <tr>
                <td>{{ lang('pd_front_custom_price') }}</td>
                <td><input type="text" name="pd_custom_price[front]" value="<?php echo $pd_custom_price['front']; ?>" />
                  <?php if ($pdErrors['custom_price']) { ?>
                  <span class="error"><?= $pdErrors['custom_price']; ?></span>
                  <?php } ?>
                </td>
              </tr>
                <tr>
                    <td>{{ lang('pd_back_custom_price') }}</td>
                    <td><input type="text" name="pd_custom_price[back]" value="<?php echo $pd_custom_price['back']; ?>" />
                        <?php if ($pdErrors['custom_price']) { ?>
                        <span class="error"><?= $pdErrors['custom_price']; ?></span>
                        <?php } ?>
                    </td>
              ...
              <tr>
                <td>{{ lang('pd_is_customize') }}</td>
                <td><select name="pd_is_customize">
                    <option value="1" <?= ($pd_is_customize == '1' ? 'selected' : ''); ?>>{{ lang('text_enabled') }}</option>
                    <option value="0" <?= ($pd_is_customize != '1' ? 'selected' : ''); ?>>{{ lang('text_disabled') }}</option>
                  <?php if ($pdErrors['is_customize']) { ?>
                  <span class="error"><?= $pdErrors['is_customize']; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td>{{ lang('pd_custom_min_qty') }}</td>
                <td><input type="text" name="pd_custom_min_qty" value="<?php echo $pd_custom_min_qty; ?>" />
                  <?php if ($pdErrors['custom_min_qty']) { ?>
                  <span class="error"><?= $pdErrors['custom_min_qty']; ?></span>
                  <?php } ?></td>
              </tr>

              <tr>
                <td>{{ lang('pd_back_image') }}</td>
                <td><div class="image"><img src="<?php echo $pd_back_thumb; ?>" alt="" id="pd_back_thumb" /><br />
                    <input type="hidden" name="pd_back_image" value="<?php echo $pd_back_image; ?>" id="pd_back_image" />
                    <a onclick="image_upload('pd_back_image', 'pd_back_thumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#pd_back_thumb').attr('src', '<?php echo $no_image; ?>'); $('#pd_back_image').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
              </tr>
          </table>
        </div>
        <?php } ?>
...
$('input[name=\'category\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#product-category').append('<div id="product-category' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" name="product_category[]" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#product-category div i', function() {
	$(this).parent().remove();
...
$('input[name=\'filter\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#product-filter').append('<div id="product-filter' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" name="product_filter[]" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#product-filter div i', function() {
	$(this).parent().remove();
...
$('input[name=\'download\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#product-download').append('<div id="product-download' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" name="product_download[]" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#product-download div i', function() {
	$(this).parent().remove();
...
$('input[name=\'related\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#product-related').append('<div id="product-related' + ui.item.value + '">' + ui.item.label + '<i class="fa fa-times"></i><input type="hidden" name="product_related[]" value="' + ui.item.value + '" /></div>');
...
$(document).on('click', '#product-related div i', function() {
	$(this).parent().remove();
...
function addAttribute() {
    ...
    <?php } ?>
	html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';
    html += '</tbody>';
...
$('input[name=\'option\']').autocomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			html += '  <table id="option-value' + option_row + '" class="table table-hover dataTable no-footer">';
			html += '  	 <thead>';
			html += '      <tr>';
			...
			html += '        <td class="left"><a onclick="addOptionValue(' + option_row + ');" class="button btn btn-primary"><?php echo $button_add_option_value; ?></a></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
...
var option_value_row = <?php echo $option_value_row; ?>;
    ...
    if ($poip_installed) {
        ...
        function poip_refresh_settings() {
            ...
            for (var i=0;i<poip_tabs.length;i++) {
                if ($(poip_tabs[i]).find('input[type=hidden][name*=\\[type\\]]').length && $.inArray($(poip_tabs[i]).find('input[type=hidden][name*=\\[type\\]]').val(), for_types) != -1 ) {
                    ...
                    $(poip_tabs[i]).find('#poip_settings_title').show();
                }
        ...
        function add_option_image(option_row, option_value_row, thumb, image, srt) {
            ...
            html += '<span class="help"><?php echo $entry_sort_order_short; ?> <input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][images]['+option_image_row+'][srt]" style="width: 25px;" value="'+current_srt+'" size="3"></span>';
...
function addDiscount() {
    ...
    <?php if ($dedicatedDomains['status'] == true) { ?>
    html += '    <td class="left"><select class="discountDedicatedCurrency" name="product_discount[' + discount_row + '][dedicated_domains]">';
    html += '    <option value="0">{{ lang('all_domains') }}</option>';
    <?php foreach ($dedicatedDomains['domains'] as $domain) { ?>
    html += '      <option data-currency="<?= $domain['currency']; ?>" value="<?php echo $domain['domain_id']; ?>"><?php echo $domain['domain']; ?></option>';
    <?php } ?>
    <?php } ?>
    html += '    </select>';
    html += '<span class="discountDedicatedCurrencySpan" data-default="<?= $defaultCurrency; ?>"><?= $defaultCurrency; ?></span></td>';
	html += '    <td class="left"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
...
function addSpecial() {
    ...
    <?php if ($dedicatedDomains['status'] == true) { ?>
	html += '    <td class="left"><select class="specialDedicatedCurrency" name="product_special[' + special_row + '][dedicated_domains]">';
    html += '    <option value="0">{{ lang('all_domains') }}</option>';
    <?php foreach ($dedicatedDomains['domains'] as $domain) { ?>
        html += '      <option data-currency="<?= $domain['currency']; ?>" value="<?php echo $domain['domain_id']; ?>"><?php echo $domain['domain']; ?></option>';
    <?php } ?>
    <?php } ?>
    html += '    </select> - ';
    html += '<span class="specialDedicatedCurrencySpan" data-default="<?= $defaultCurrency; ?>"><?= $defaultCurrency; ?></span></td>';
	html += '    <td class="left"><a onclick="$(\'#special-row' + special_row + '\').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
