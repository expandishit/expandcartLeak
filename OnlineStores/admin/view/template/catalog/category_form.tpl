...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a name="btnSave" onclick="$('#form').submit();" class="button btn btn-primary"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button btn btn-primary"><?php echo $button_cancel; ?></a><?php if(isset($_GET['category_id'])) { ?><a target="_blank" href="<?= $this->fronturl->link('product/category', 'path=' . $_GET['category_id']); ?>" class="button btn btn-primary"><?php echo $text_preview; ?></a><?php } ?></div>
    </div>
    <div class="content">
                  ...
                  <table class="form">
                    ...
                    <tr>
                      ...
                      <td><div id="category-filter" class="scrollbox">
                          ...
                          <div id="category-filter<?php echo $category_filter['filter_id']; ?>" class="<?php echo $class; ?>"><?php echo $category_filter['name']; ?> <i class="fa fa-times"></i>
