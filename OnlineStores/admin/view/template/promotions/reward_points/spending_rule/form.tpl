...
<?php } ?>
    ...
    <div class="heading">
        ...
        <div class="buttons">
            ...
            <a onclick="if(confirm('<?php echo $this->language->get("Are you sure want to delete this rule?"); ?>')) location.href = '<?php echo $this->url->link('promotions/reward_points/spendingRuleDelete', 'token=' . $this->session->data['token']."&rule_id=".$this->request->get['rule_id'], 'SSL');?>';" href="javascript:;" class="button btn btn-danger"><?php echo $this->language->get('button_delete'); ?></a>
                            ...
                            <ul class="rule-param-children">
                                ...
                                <li>
                                    <span class="rule-param rule-param-new-child">
                                        <a href="javascript:void(0)" class="label"><img src="view/image/rewardpoints/rule_component_add.gif" class="rule-param-add v-middle" alt="" title="<?php echo $this->language->get('Add'); ?>"></a><span class="element">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="rule_simple_action" name="actions" class="">
                                        <option value="1" <?php echo ($actions == "1" ? 'selected=="selected"' : '')?>><?php echo $this->language->get('Do Not Allow to Use Reward Points')?></option>
                                        <option value="2" <?php echo ($actions == "2" ? 'selected=="selected"' : '')?>><?php echo $this->language->get('Allow to Use Unlimited Points')?></option>
                                        <option value="3" <?php echo ($actions == "3" ? 'selected=="selected"' : '')?>><?php echo $this->language->get('Allow to use fixed Reward Points (X) per order')?></option>
                                        <option value="4" <?php echo ($actions == "4" ? 'selected=="selected"' : '')?>><?php echo $this->language->get('Spend (Y) to allow to use Reward Points (X)')?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
									...
									<p class="note">
										<span><?php echo $this->language->get('Set 0 If you choice'); ?> <?php echo $this->language->get('Allow to Use Unlimited Points')?></span>
									</p>
