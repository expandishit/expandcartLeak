  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <br />
        <table id="tax-rule" class="table table-hover dataTable no-footer">
          <thead>
            <tr>
          ...
          <tbody id="tax-rule-row<?php echo $tax_rule_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#tax-rule-row<?php echo $tax_rule_row; ?>').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $tax_rule_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="3"></td>
              <td class="left"><a onclick="addRule();" class="button btn btn-primary"><?php echo $button_add_rule; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addRule() {
	...
	html += '    <td class="left"><a onclick="$(\'#tax-rule-row' + tax_rule_row + '\').remove();" class="button btn btn-primary"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
