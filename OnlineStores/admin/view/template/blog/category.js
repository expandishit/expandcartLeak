        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `<a href="${links['update']}?category_id=${row.category_id}">${data}</a>`;
                }
            },
            {
                targets: 3,
            ...
            },
            {
                ...
                selectable: false,
                render: function (data, type, row) {
                    return `<a data-popup="tooltip" title="${locales['text_preview']}" target="_blank" href="${links['preview']}${row['category_id']}" class='text-default'><i class='fa fa-eye fa-lg valign-middle'></i></a>`;
                }
            },
            {
                targets: 6,
...
function btnEditItem(id) {
    return `<a href="`+ links['update'] + `?category_id=` + id +`" title="` + locales['button_edit'] + `">
