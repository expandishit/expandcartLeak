        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `<a href="${links['update']}?post_id=${row.post_id}">${data}</a>`;
                }
            },
            {
                targets: 3,
                ...
                render: function (data, type, row) {
                    ...
                    return statusSwitch(row.post_description_id, status);
                }
            },
            {
                targets: 4,
            ...
            },
            {
                ...
                selectable: false,
                render: function (data, type, row) {
                    return `<a data-popup="tooltip" title="${locales['text_preview']}" target="_blank" href="${links['preview']}${row['post_id']}" class='text-default'><i class='fa fa-eye fa-lg valign-middle'></i></a>`;
                }
            },
            {
                targets: 8,
...
function btnEditItem(id) {
    return `<a href="` + links['update'] + `?post_id=` + id + `" title="` + locales['button_edit'] + `">
