...
<div id="content">
    ...
    <div class="box">
        <div class="heading">
            <h1>{{ lang('heading_edit_post') }}</h1>
            <div class="buttons">
                <a onclick="$('#editPostForm').submit();" class="button btn btn-primary">
                    {{ lang('button_save') }}
                </a>
                <a href="<?= $links['viewPost']; ?>" class="button btn btn-primary">
                    <span>{{ lang('button_view_post') }}</span>
                </a>
        ...
        <form id="editPostForm" method="post" action="<?= $links['editPost']; ?>">
            <div>
