...
<div class="md-modal md-effect-11" id="modal-merge-orders">
  <div class="md-content">
    <div class="modal-header red-bg">
      <button class="md-close close">×</button>
      <h4 class="modal-title"><?php echo $text_merge_orders_dialog_title; ?> <span id="ps-title"></span></h4>
    </div>
    <div class="modal-body">
      <p><?php echo $text_merge_orders_dialog_message; ?></p>

      <p><?php echo $text_merge_orders_dialog_message_conf; ?></p>
    </div>
    <div class="modal-footer">
      <span class="server-loading"><i class="fa fa-refresh fa-spin"></i></span>
      <button type="button" class="btn btn-danger" onclick="$('#form').attr('action', '<?php echo $mergeOrders; ?>'); $('#form').attr('target', '_self'); $('#form').submit();"><?php echo $text_merge_orders_dialog_merge; ?></button>
      <button type="button" class="btn btn-default" onclick="$(this).parents('.md-show').removeClass('md-show');"><?php echo $text_merge_orders_dialog_cancel; ?></button>
    </div>
  </div>
</div>
...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
        <button data-modal="modal-merge-orders" type="submit" class="md-trigger button btn btn-primary"><?php echo $button_mergeOrders; ?></button>
        ...
        <a onclick="$('#form').attr('action', '<?php echo $delete; ?>'); $('#form').attr('target', '_self'); $('#form').submit();" class="button btn btn-danger"><?php echo $button_delete; ?></a>
      </div>
    </div>
    <div class="content">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left">
                  ...
                  <?php if ($order['customer_status'] > 1) { ?>
                  <div style="color: tomato;">{{ lang('customer_waiting_activation') }}</div>
                  <?php } ?>
              </td>
