      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-transaction">
          <table class="form">
            ...
            <tr>
              <td colspan="2" style="text-align: right;"><a id="button-reward" class="button btn btn-primary" onclick="addTransaction();"><span><?php echo $button_add_transaction; ?></span></a></td>
            </tr>
          </table>
