...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <?php if ($no_customer): ?>
        <center><h2 class="text-danger"> <i class="fa fa-frown-o"></i> <?= $title_no_customer_exists ?></h2></center>
        <?php die(); ?>
      <?php endif ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                <td><?php echo $entry_payment_telephone; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][payment_telephone]" value="<?php echo $address['telephone']; ?>" /></td>
              </tr>
              <tr>
        ...
        <div id="tab-history">
          ...
          <table class="form">
            ...
            <tr>
              <td colspan="2" style="text-align: right;"><a id="button-history" class="button btn btn-primary"><span><?php echo $button_add_history; ?></span></a></td>
            </tr>
          </table>
        </div>
        <div id="tab-transaction">
          <table class="form">
            ...
            <tr>
              <td colspan="2" style="text-align: right;"><a id="button-transaction" class="button btn btn-primary" onclick="addTransaction();"><span><?php echo $button_add_transaction; ?></span></a></td>
            </tr>
          </table>
        ...
        <div id="tab-reward">
          <table class="form">
            ...
            <tr>
              <td colspan="2" style="text-align: right;"><a id="button-reward" class="button btn btn-primary" onclick="addRewardPoints();"><span><?php echo $button_add_reward; ?></span></a></td>
            </tr>
          </table>
          <div id="reward"></div>
        </div>
...
function addAddress() {	
    ...
    html += '    </tr>';
    html += '    <tr>';
    html += '      <td><?php echo $entry_payment_telephone; ?></td>';
    html += '      <td><input type="text" name="address[' + address_row + '][payment_telephone]" value="" /></td>';
    html += '    </tr>';
    html += '    <tr>';
...
//--></script> 
<script type="text/javascript"><!--
$(document).on('click', '#transaction .pagination a', function() {
...
//--></script> 
<script type="text/javascript"><!--
$(document).on('click', '#reward .pagination a', function() {
