  ...
  <div class="box">
    ...
    <div class="content">
        ...
        <div id="tab-payment" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="payment_telephone" value="<?php echo $payment_telephone; ?>" /></td>
            </tr>
            <tr>
        ...
        <div id="tab-product" class="vtabs-content">
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="left"><?php echo $order_product['name']; ?><br />
                  ...
                  <input type="hidden" name="order_product[<?php echo $product_row; ?>][product_status]" value="<?php echo $order_product['product_status']; ?>" />
                  ...
                  <?php if ($order_product['rentData']) { ?>
                  <div>
                      {{ lang('product_for_rent_from') }}
                    <?= $order_product['rentData']['range']['from']; ?>
                      {{ lang('product_for_rent_to') }}
                    <?= $order_product['rentData']['range']['to']; ?>
                      {{ lang('product_for_rent_for') }}
                    <?= $order_product['rentData']['diff']; ?>
                      {{ lang('text_day') }}
                  </div>
                  <?php } ?>

                  <?php if ($order_product['pricePerMeterData']) { ?>
                    <div>
                        <?php if ($order_product['pricePerMeterData']['skirtings_status'] ==1) { ?>
                        - <small>{{ lang('text_skirtings') }}: <?= $order_product['pricePerMeterData']['skirtings']; ?> {{ lang('text_meter') }}</small><br/>
                        <?php }?>
                        <?php if ($order_product['pricePerMeterData']['metalprofile_status'] == 1) { ?>
                        - <small>{{ lang('text_metalprofiles') }}: <?= $order_product['pricePerMeterData']['metalProfiles']; ?> {{ lang('text_metalProfiles_unit') }}</small><br/>
                        <?php }?>

                        - <small>{{ lang('text_amount') }}: <?= $order_product['pricePerMeterData']['underlaymen']; ?> {{ lang('text_meter') }}

                         <?php if ($product['pricePerMeterData']['main_unit'] == 2) { ?>
          ...
          <table class="table table-hover dataTable no-footer">
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-product" class="button btn btn-primary"><?php echo $button_add_product; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-voucher" class="vtabs-content">
          ...
          <table class="table table-hover dataTable no-footer">
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-voucher" class="button btn btn-primary"><?php echo $button_add_voucher; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-total" class="vtabs-content">
          ...
          <table class="table table-hover dataTable no-footer">
            ...
            <tfoot>
              <tr>
                <td class="left">&nbsp;</td>
                <td class="left"><a id="button-update" class="button btn btn-primary"><?php echo $button_update_total; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
      ...
      <div id="tab-pd_custom" class="vtabs-content">
        <form enctype="multipart/form-data" id="pd_custom_designer">
        <table class="table table-hover dataTable no-footer">
          <thead>
          <tr>
            <td class="left"><?php echo $column_product; ?></td>
          ...
          <tr>
            ...
            <td><a href="<?= $product['new_design_front_image']; ?>" target="_blank">
          ...
          <tr>
            ...
            <td>
              <?php foreach ($product['front_info'] as $front_key => $front_info) { ?>
              ...
              <div>
                ...
                <input type="hidden" name="orig_images[<?= $product['did']; ?>][front_image][<?= $front_key; ?>]" value="<?= $front_info['id']; ?>" class="org_front_image" />
                <input id="change_front_image_<?= $front_key ?>" class="change_front_image" data-id="<?= $front_key; ?>" type="button" value="{{ lang('change_image') }}" />
                <div id="front_image_<?= $front_key ?>_div" class="hide front_image_divs">
                  <input type="file" name="front_image[<?= $product['did']; ?>][<?= $front_key ?>]" />
                </div>
              </div>
          ...
          <tr>
            ...
            <td>
              <?php foreach ($product['back_info'] as $back_key => $back_info) { ?>
              ...
              <div>
                ...
                <input type="hidden" name="orig_images[<?= $product['did']; ?>][back_image][<?= $back_key; ?>]" value="<?= $back_info['id']; ?>" class="org_back_image" />
                <input id="change_back_image_<?= $back_key ?>" class="change_back_image" data-id="<?= $back_key; ?>" type="button" value="{{ lang('change_image') }}" />
                <div id="back_image_<?= $back_key ?>_div" class="hide back_image_divs">
                  <input type="file" name="back_image[<?= $product['did']; ?>][<?= $back_key ?>]" />
                </div>
              </div>
              ...
              <div>
                ...
                <a href="<?= $http_image . 'modules/pd_images/modified_image/' . $back_info['modified_image']; ?>" target="_blank">
          ...
          <tr>
            <td colspan="8">
              <input type="submit" id="pd_custom_submit" name="pd_custom_submit" value="{{ lang('button_save') }}" />
              <input type="hidden" id="did" name="did[]" value="<?= $product['did']; ?>" />
            </td>
          </tr>
          </tfoot>
        </table>
...
<script type="text/javascript">
    ...
    $('.change_front_image').click(function(e) {
        var that = $(this);
        var dataKey = that.attr('data-id');
        var front_image_div = $('#front_image_' + dataKey + '_div');

//        $('.front_image_divs').hide();

//        front_image_div.show();
//        front_image_div.removeClass('hide');
        front_image_div.toggleClass('hide');
    });

    $('.change_back_image').click(function(e) {
        var that = $(this);
        var dataKey = that.attr('data-id');
        var back_image_div = $('#back_image_' + dataKey + '_div');

//        $('.front_image_divs').hide();

//        front_image_div.show();
//        front_image_div.removeClass('hide');
        back_image_div.toggleClass('hide');
    });

    $('#pd_custom_designer').submit(function (event) {
        event.preventDefault();
        var formData = new FormData(this);
//        var pd_inputs = $('#pd_custom_designer :input[type=file]').serialize();
        $.ajax({
            url: '<?= $pd_submit_url; ?>',
            method: 'post',
            data: formData,
            ...
            success: function (response) {
              window.location.href = '<?= $pd_refresh_url; ?>';
            }
        });
    });
...
$(document).on('change', 'select[id=\'customer_group_id\']', function() {
...
//--></script> 
<script type="text/javascript"><!--
$(document).on('click', '#button-product, #button-voucher, #button-update', function() {
