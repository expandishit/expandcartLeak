    ...
    <div class="heading">
      ...
      <div class="buttons"><?php if(isset($stores)){ ?>
        <select onChange="location='<?php echo $module_link; ?>&store_id='+$(this).val()">
          ...
          <?php } ?>
          <?php } ?>
        </select><?php } ?><a onClick="saveAndStay()" class="button btn btn-primary"><span><?php echo $button_save_and_stay; ?></span></a><a onclick="$('#form').submit();" class="button btn btn-primary"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button btn btn-primary"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <ul>
          ...
          <li><a href="#designcheckout" id="vtab_item_1" class="vtab-item"><i class="icon-design"></i><span><?php echo $text_design; ?></span></a></li>
...
<div class="col-sm-6 col-md-4"><a href="#general" class="tab-trigger"><i class="icon-settings icon-large"></i><h3><?php echo $text_general; ?></h3><span><?php echo $text_general_intro; ?></span></a></div>
 ...
 <div class="col-sm-6 col-md-4"><a href="#shipping_address" class="tab-trigger"><i class="icon-address icon-large"></i><h3><?php echo $text_shipping_address; ?></h3><span><?php echo $text_shipping_address_intro; ?></span></a></div>
  ...
  <div class="clear  visible-xs"></div>
  <div class="col-sm-6 col-md-4"><a href="#designcheckout" class="tab-trigger"><i class="icon-design icon-large"></i><h3><?php echo $text_design; ?></h3><span><?php echo $text_design_intro; ?></span></a></div>
  <div class="clear  visible-sm visible-xs"></div>
  <div class="col-sm-6 col-md-4"><a href="#analytics" class="tab-trigger"><i class="icon-chart-bar icon-large"></i><h3><?php echo $text_analytics; ?></h3><span><?php echo $text_analytics_intro; ?></span></a></div>
      ...
      <div id="general" class="vtabs-content">
        ...
        <div class="tab-body">
          <div class="row">
            <div class="col-md-6"><div class="wrap-5"><table class="table table-hover dataTable no-footer">
                <tr>
                ...
                <tr>
                  ...
                  <td class="settings"><input type="hidden" value="0" name="quickcheckout[general][clear_session]" />
                    ...
                    <label  for="general_clear_session"><?php echo $settings_enable; ?></label></td>
                        ...
                        <tr>
                            <td class="name"><span><?php echo $text_display_country_code; ?></span><i class="icon-question" rel="tooltip"  data-help="<?php echo $text_display_country_code_tooltip; ?>"></i></td>
                            <td class="settings"><input type="hidden" value="0" name="quickcheckout[general][display_country_code]" />
                                <?php if(isset($quickcheckout['general']['display_country_code']) && $quickcheckout['general']['display_country_code'] == 1){ ?>
                                <input class="styled" type="checkbox" value="1" name="quickcheckout[general][display_country_code]" checked="checked" id="display_country_code" />
                                <?php }else{ ?>
                                <input class="styled" type="checkbox" value="1" name="quickcheckout[general][display_country_code]" id="display_country_code" />
                                <?php } ?>
                                <label  for="display_country_code"><?php echo $settings_enable; ?></label></td>
                        </tr>
                <tr>
      ...
      <div id="login" class="vtabs-content">
        ...
        <div class="tab-body table-form row">
            ...
            <div id="sortable_social_login" class="atab col-md-5">
              ...
              <div class="col-md-7">
                <div class="wrap-5">
                  ...
                  <div class="row">
                  <a class="button btn btn-primary" href="<?php echo $link_social_login_edit; ?>"><?php echo $text_social_login_edit?></a>
                  </div>
                </div>
              </div>
            <?php }else{ ?>
        ...
        <table class="table table-hover dataTable no-footer">
                <tbody>
                  ...
                  <td class="settings">
                    ...
                    <select name="quickcheckout[step][shipping_method][input_style]">
                ...
                <tbody>
                  ...
                  <td class="name"><span><?php echo $text_payment_method_input_style; ?></span><i class="icon-question" rel="tooltip"  data-help="<?php echo $payment_method_input_style_tooltip; ?>"></i></td>
                    ...
                    <?php if(isset($quickcheckout['step']['payment_method']['input_style']) && $quickcheckout['step']['payment_method']['input_style'] == 'radio'){ ?>
                        <select name="quickcheckout[step][payment_method][input_style]">
                            <option selected value="radio">Radio</option>
                            <option value="select">Select</option>
                        </select>
                    <?php }else{ ?>
      ...
      <!---------------------------------- Design ---------------------------------->
      <div id="designcheckout" class="vtabs-content">
        ...
        <table class="form">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="settings" colspan="2">
                    <?php if(isset($quickcheckout['general']['address_style']) && $quickcheckout['general']['address_style'] == 'radio'){ ?>
                        <select name="quickcheckout[general][address_style]">
                            <option selected value="radio">Radio</option>
                            <option value="select">Select</option>
                        </select>
                      <?php }else{ ?>
