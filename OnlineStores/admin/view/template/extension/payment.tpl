<?php include_jsfile($header, $footer, 'view/template/extension/payment.tpl.js'); ?>
...
<script>
    ...
    var deactivateURL = 'index.php?route=extension/payment/deactivate&token=<?php echo $token; ?>&psid=';
    var disableURL = 'index.php?route=extension/payment/disable&token=<?php echo $token; ?>';
    var enableURL = 'index.php?route=extension/payment/enable&token=<?php echo $token; ?>';
</script>
    ...
    <div class="col-lg-12">
                ...
                <div class="main-box clearfix activated-methods">
                    ...
                    <div class="main-box-body clearfix psmethod-container">
                        <div class="widget-psmethod">
                            <?php foreach ($activated_gateways as $gateway) { ?>
            ...
            <div class="col-lg-12">
                <div class="main-box clearfix available-methods">
                    <header class="main-box-header psmethods clearfix emerald-bg">
                        <h1 class="pull-left"><?php echo $entry_paypal; ?></h1>
                        <div class="pull-right">
                            <i class="fa fa-chevron-up"></i>
                        </div>
                    </header>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-box clearfix available-methods">
                    <header class="main-box-header psmethods clearfix emerald-bg">
                        <h1 class="pull-left"><?php echo $entry_acceptcc; ?></h1>
                        <div class="pull-right">
                            <i class="fa fa-chevron-up"></i>
                        </div>
                    </header>
                    ...
                    <div class="main-box-body clearfix psmethod-container">
                        <div class="widget-psmethod">
                            <?php foreach ($credit_cards as $gateway) { ?>
                            <div class="row method">
                                <div class="img col-lg-2 col-sm-2 col-xs-4">
                                    <img src="<?php echo $gateway['image']; ?>" alt="<?php echo $gateway['image_alt']; ?>">
                                </div>
        ...
        <?php if ($prepaid_cards) { ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="main-box clearfix available-methods">
                    <header class="main-box-header psmethods clearfix emerald-bg">
                        <h1 class="pull-left"><?php echo $entry_prepaidcards; ?></h1>
                        <div class="pull-right">
                            <i class="fa fa-chevron-up"></i>
                        </div>
                    </header>
                    ...
                    <div class="main-box-body clearfix psmethod-container">
                        <div class="widget-psmethod">
                            <?php foreach ($prepaid_cards as $gateway) { ?>
                            <div class="row method">
                                <div class="img col-lg-2 col-sm-2 col-xs-4">
                                    <img src="<?php echo $gateway['image']; ?>" alt="<?php echo $gateway['image_alt']; ?>">
                                </div>
