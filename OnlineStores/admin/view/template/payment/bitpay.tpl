      ...
      <div id="tab-settings">
        ...
        <div id="tab-general" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><label for="bitpay_api_key"><span class="required">*</span> <?php echo $entry_api_token; ?></label><span class="help" id="api_key_help"><?php if (isset($bitpay_api_server) && $bitpay_api_server == 'live') { echo $help_api_key; }else{ echo $help_api_key_test; } ?></span></td>
            ...
            <tr>
              ...
              <td><select name="bitpay_status"  id="bitpay_status">
                  <?php if ($bitpay_status === "1") { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } elseif ($bitpay_status === "0") { ?>
