...
<div id="content">
	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons"><a onclick="saveSettings($(this))" class="button btn btn-primary"><?php echo $button_save; ?></a><a href="<?php echo $exit; ?>" class="button btn btn-primary"><?php echo $button_cancel; ?></a></div>
		</div>
	</div>
					...
					<?php foreach ($language_array as $language_code => $language_name) { ?>
						<?php
						 ...
						 if(is_array($setting['default'])) {
						 	if(isset($setting['default'][$language_code])) {
						 		$default = $setting['default'][$language_code];
						 	} else {
						 		$default = $setting['default']['en'];
						 	}
						 } elseif (isset($setting['default'])) {
						 	$default = $setting['default'];
						 }
						?>
						<?php $value = (isset($saved[$key.'_'.$language_code])) ? $saved[$key.'_'.$language_code] : $default; ?>
