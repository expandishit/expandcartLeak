                    ...
                    <table class="form">
                        <tr>
                            ...
                            <td><select name="payfort_fort_status">
                                    <option value="1" <?php echo ($payfort_fort_status !== '0') ? 'selected="selected"' : '' ?>><?php echo $text_enabled; ?></option>
                                    <option value="0" <?php echo ($payfort_fort_status === '0') ? 'selected="selected"' : '' ?>><?php echo $text_disabled; ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="payfort_fort_credit_card">
                                    <option value="1" <?php echo ($payfort_fort_credit_card !== '0') ? 'selected="selected"' : '' ?>><?php echo $text_enabled; ?></option>
                                    <option value="0" <?php echo ($payfort_fort_credit_card === '0') ? 'selected="selected"' : '' ?>><?php echo $text_disabled; ?></option>
                                </select>
