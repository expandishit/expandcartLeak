...
<div class="box">
	<div class="heading">
		...
		<div class="buttons">
			<a id="ms-submit-button" class="button btn btn-primary"><?php echo $button_save; ?></a>
	...
	<table id="attribute-value" class="table table-hover dataTable no-footer">
		<thead>
			<tr>
...
$(function() {
	$('body').delegate(".browseFiles", "click", function() {
		var thumb = $(this).prevAll('img').attr('id', 'imgMgrThumb').attr('id');
		var field = $(this).prevAll('input').attr('id', 'imgMgrField').attr('id');
