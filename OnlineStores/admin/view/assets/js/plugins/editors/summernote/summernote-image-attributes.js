    ...
    $.extend($.summernote.plugins, {
        'imageAttributes': function (context) {
            ...
            this.initialize = function () {
                ...
                if (options.imageAttributes.disableImage == false) {
                    body+='  <li class="active"><a href="#note-imageAttributes' + timestamp + '" data-toggle="tab">' + lang.imageAttributes.tabImage + '</a></li>' ;
                }
                if (options.imageAttributes.disableAttributes == false) {
                    body+='  <li><a href="#note-imageAttributes-attributes' + timestamp + '" data-toggle="tab">' + lang.imageAttributes.tabAttributes + '</a></li>' ;
                }
