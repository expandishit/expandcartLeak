...
License MIT
*/
!function(t,e,s,a){var i='<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> ';t.DirtyForms.dialog={title:i+"Are you sure you want to do that?",proceedButtonClass:"dirty-proceed",proceedButtonText:"Leave This Page",stayButtonClass:"dirty-stay",stayButtonText:"Stay Here",dialogID:"dirty-dialog",titleID:"dirty-title",messageClass:"dirty-message",preMessageText:"",postMessageText:"",replaceText:!0,open:function(e,s){var a=t("#"+this.dialogID);0===a.length&&(a=t('<div id="'+this.dialogID+'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="'+this.titleID+'"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h3 class="modal-title" id="'+this.titleID+'"></h3></div><div class="modal-body '+this.messageClass+'"></div><div class="modal-footer"><button type="button" class="'+this.proceedButtonClass+' btn btn-warning" data-dismiss="modal"></button><button type="button" class="'+this.stayButtonClass+' btn btn-default" data-dismiss="modal"></button></div></div></div></div>'),t("body").append(a).data("df-dialog-appended",!0)),this.replaceText&&(a.find("#"+this.titleID).html(this.title),a.find("."+this.messageClass).html(this.preMessageText+s+this.postMessageText),a.find("."+this.proceedButtonClass).html(this.proceedButtonText),a.find("."+this.stayButtonClass).html(this.stayButtonText)),e.bindEscKey=!1;var i=function(){e.proceed=t.DirtyForms.choiceContinue=!0},o=function(s){var i=e.isDF1?t.DirtyForms.choiceCommit:e.commit;i(s),t("body").data("df-dialog-appended")===!0&&a.remove()};a.find("."+this.proceedButtonClass).off("click",i).on("click",i),a.off("hidden.bs.modal",o).on("hidden.bs.modal",o),a.modal({show:!0})},fire:function(t,e){this.title=i+e,this.open({isDF1:!0},t)},bind:function(){},stash:function(){return!1},refire:function(){return!1},selector:"no-op"}}(jQuery,window,document);
