...
class ControllerPaymentMoamalat extends Controller
{
    ...
    public function index()
    {
        ...
        // form fields
        $formFields = [
            "status", "test_mode", "merchant_id", "secret_key", "terminal_id", "completed_order_status_id", 
    ...
    private function validate()
    {
        ...
        if (!$this->request->post["{$this->paymentName}_terminal_id"]) {
            $this->error["{$this->paymentName}_terminal_id"] = $this->language->get("error_terminal_id");
        }
