...
class ControllerCatalogAttribute extends Controller
{
    ...
    public function insert()
    {
		...
		if ( $this->request->server['REQUEST_METHOD'] == 'POST' )
        {
            ...
            $attributeId = $this->model_catalog_attribute->addAttribute($this->request->post);
		  	if($attributeId){
		  		$this->session->data['success'] = $result_json['success_msg'] = $this->language->get('text_success');
				$result_json['success'] = '1';
				//$result_json['data'] = $this->model_catalog_attribute->getAttribute($attributeId);
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
	  		$updt = $this->model_catalog_attribute->editAttribute($this->request->get['attribute_id'], $this->request->post);
        ...
        $this->data['links'] = [
            'submit' => $this->url->link('catalog/attribute/update', 'attribute_id=' . $this->request->get['attribute_id'], 'SSL')
        ];
  	...
  	protected function getList()
    {
        ...
        $this->data['attrgroup'] = $this->url->link('catalog/attribute_group', 'token=' . $this->session->data['token'] . $url, 'SSL');
...
//			'limit' => $this->config->get('config_admin_limit')
		...
		$this->data['links'] = [
            'attributeGroups' => $this->url->link('catalog/attribute_group', '', 'SSL')
        ];

		$this->template = 'catalog/attribute_list.expand';
		$this->children = array(
			'common/header',
			'common/footer'
		);
  	...
  	protected function getForm()
    {
        ...
        $this->data['breadcrumbs'][] = array(
            'text'      => !isset($this->request->get['attribute_id']) ? $this->language->get('breadcrumb_insert') : $this->language->get('breadcrumb_update'),
            'href'      => $this->url->link('catalog/attribute', 'token=' . $this->session->data['token'] . $url, 'SSL'),
            'separator' => ' :: '
        );
		...
		$this->template = 'catalog/attribute_form.expand';
		$this->children = array(
			'common/header',
			'common/footer'
		);
    ...
    public function groupedAutocomplete() {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            $results = $this->model_catalog_attribute->getGroupedAttributes($data);
