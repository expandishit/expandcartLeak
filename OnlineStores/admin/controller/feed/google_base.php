...
class ControllerFeedGoogleBase extends Controller {
	...
	public function index() {
		...
		$this->data['entry_feed_language'] = $this->language->get('entry_feed_language');
		...
		$this->data['all_languages'] = $this->model_localisation_language->getLanguages();

		$this->data['selected_language'] = $this->config->get('google_base_feed_language') ? $this->config->get('google_base_feed_language') : '' ;
