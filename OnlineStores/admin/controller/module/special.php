...
class ControllerModuleSpecial extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->redirect($this->url->link('extension/productpromo', '', 'SSL'));
		}
		...
		if (isset($this->error['image'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/special', '', 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('module/special', '', 'SSL');
		
		$this->data['cancel'] = $this->url->link('extension/productpromo', '', 'SSL');
