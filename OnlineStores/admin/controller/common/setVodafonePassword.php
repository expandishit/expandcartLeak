...
class ControllerCommonSetVodafonePassword extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($user_info) {
			...
			$this->data['action'] = $this->url->link('common/setVodafonePassword', 'code=' . $code, 'SSL');
			...
			$this->template = 'common/setVodafonePassword.expand';
