<?php
class ControllerReportZonePurchased extends Controller {
	...
	public function index() {   
        ...
        $this->data['filter_date_end'] = date('y/m/d');
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/zone_purchased', '', 'SSL'),
      		'separator' => ' :: '
   		);
        ...
        $this->data['action'] = $this->url->link('report/zone_purchased/ajaxResponse', $comming_from, 'SSL');
		...
		$this->data['export_link'] = $this->url->link('tool/w_export_tool/exportZonePurchasedReport', '', 'SSL');
		
		$this->template = 'report/zone_purchased.expand';
		$this->children = array(
			'common/header',
			'common/footer'
		);
    ...
    public function ajaxResponse()
    {
        ...
        $results = $this->model_report_zone->getPurchasedDataTable($data, $requestData, $columns);
        $product_total = $results['total_records'];
