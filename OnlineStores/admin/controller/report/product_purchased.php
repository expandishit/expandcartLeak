...
class ControllerReportProductPurchased extends Controller
{
    ...
    public function index()
    {
        ...
        $this->data['action'] = $this->url->link('report/product_purchased/ajaxResponse', $comming_from, 'SSL');
        ...
        $this->data['export_link'] = $this->url->link('tool/w_export_tool/exportProductPurchasedReport', '', 'SSL');
        
        $this->template = 'report/product_purchased.expand';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    public function ajaxResponse()
    {
        ...
        $data = array(
            ...
            'filter_all_products'    => $filterDAta,
