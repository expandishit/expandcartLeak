...
class ControllerReportSaleShipping extends Controller {
	...
	public function index() {     
		...
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/sale_shipping', '', 'SSL'),
      		'separator' => ' :: '
   		);
        $comming_from = '';
        ...
        $this->data['action'] = $this->url->link('report/sale_shipping/ajaxResponse', $comming_from, 'SSL');
        ...
        $this->data['export_link'] = $this->url->link('tool/w_export_tool/exportShippingReport', '', 'SSL');

		$this->template = 'report/sale_shipping.expand';
		$this->children = array(
			'common/header',
			'common/footer'
		);
    ...
    public function ajaxResponse()
    {
        ...
        $results = $this->model_report_sale->getShippingDataTable($data, $requestData, $columns);
