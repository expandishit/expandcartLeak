<?php
class ControllerSettingStoreCheckout extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->data['action'] = $this->url->link('setting/store_checkout');
        
        $this->data['cancel'] = $this->url->link('setting/store_checkout');
...
//            'config_auto_generate_invoice_no',
            ...
            'config_stop_auto_generate_invoice_no',
        ]);

        $this->template = 'setting/store_checkout.expand';
