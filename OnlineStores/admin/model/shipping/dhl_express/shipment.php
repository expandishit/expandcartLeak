<?php
class ModelShippingDhlExpressShipment
{
    ...
    public function hit_get_postcode_city($country, $city, $postcode) {
    ...
    public function hit_get_package_piece($dhl_packages) {
        $pieces = "";
        if ($dhl_packages) {
    ...
    public function hit_get_pack_type($selected) {
        $pack_type = 'BOX';
        if ($selected == 'FLY') {
            $pack_type = 'FLY';
        } 
