	...
	public function recursiveDelete( $parent, $store_id = 0 )
	{
		...
		if (isset($index[$parent_id])) {
			foreach ($index[$parent_id] as $id) {
		        if (function_exists('delete_child_nodes')) {
...
$sql[] = "INSERT INTO `".DB_PREFIX."megamenu_widgets` VALUES (6, 'ExpandCart Feed', 'feed', 'a:1:{s:8:\"feed_url\";s:55:\"http://www.expandcart.com/?type=rss\";}', 0);";
