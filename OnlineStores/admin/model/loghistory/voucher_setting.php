<?php
class ModelLoghistoryVoucherSetting extends Model {
	public function getTotalVoucherSettings($data = array()) {
        ...
        $implode[] = " action = 'updateVoucherOptions' ";
    ...
    public function ajaxResponse($data, $request)
    {
        ...
        $implode[] = " lh.action = 'updateVoucherOptions' ";
        ...
        $total = $this->getTotalVoucherSettings($data);
