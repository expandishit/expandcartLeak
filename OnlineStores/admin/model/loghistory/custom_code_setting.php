<?php
class ModelLoghistoryCustomCodeSetting extends Model {
	public function getTotalCustomCodeSettings($data = array()) {
        ...
        $implode[] = " action = 'updateCustomCode' ";
    ...
    public function ajaxResponse($data, $request)
    {
        ...
        $implode[] = " lh.action = 'updateCustomCode' ";
        ...
        $total = $this->getTotalCustomCodeSettings($data);
