<?php
class ModelLoghistoryTaxesSetting extends Model {
	public function getTotaltaxesSettings($data = array()) {
        ...
        $implode[] = " action = 'updateTaxOptions' ";
    ...
    public function ajaxResponse($data, $request)
    {
        ...
        $implode[] = " lh.action = 'updateTaxOptions' ";
        ...
        $total = $this->getTotaltaxesSettings($data);
    ...
    public function getHistoryInfo($log_id)
    {
        ...
        if(count($query->row) > 0){
            ...
            $logData['tax_classes'] = $this->model_localisation_tax_class->getTaxClasses();
        }
