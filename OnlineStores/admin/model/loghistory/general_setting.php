<?php
class ModelLoghistoryGeneralSetting extends Model {
	public function getTotalGeneralSettings($data = array()) {
    ...
    public function ajaxResponse($data, $request)
    {
       ...
       // $sql .= " LEFT JOIN `" . DB_PREFIX . "currency` cu ON (lh.reference_id = cu.currency_id) ";
        ...
        $implode[] = " lh.type = 'general_setting' ";
        ...
        $total = $this->getTotalGeneralSettings($data);
