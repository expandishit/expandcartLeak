...
$_['column_merchant_id']				  = 'Merchant ID (MID)';
$_['column_capture_id']					  = 'Capture ID';
$_['column_reference']					  = 'Klarna Reference';
$_['column_status']						  = 'الحالة';
$_['column_fraud_status']				  = 'Fraud Status';
...
$_['entry_colour_button']				  = 'لون خلفية الزر:';
$_['entry_colour_button_text']			  = 'لون نص الزر:';
$_['entry_colour_checkbox']				  = 'لون خلفية مربع الاختيار:';
$_['entry_colour_checkbox_checkmark']	  = 'لون علامة مربع الإختيار:';
$_['entry_colour_header']				  = 'لون العنوان:';
$_['entry_colour_link']					  = 'لون الروابط:';
$_['entry_separate_shipping_address']	  = 'Allow Separate Shipping Address:<br /><span class="help">If yes, the consumer can enter different billing and shipping addresses.</span>';
$_['entry_dob_mandatory']				  = 'Date Of Birth Mandatory (UK stores only):<br /><span class="help">If yes, the consumer cannot skip date of birth.</span>';
$_['entry_title_mandatory']				  = 'Title Mandatory (UK stores only):<br /><span class="help">If specified to no, title becomes optional in countries that by default require title.</span>';
$_['entry_additional_text_box']			  = 'Allow Newsletter Signup:<br /><span class="help">Allows newsletter signup within the iFrame for logged in users.</span>';
$_['entry_total']						  = 'الاجمالي';
$_['klarna_checkout_total_note']		  = 'إجمالي مبلغ الطلب قبل أن تصبح طريقة الدفع هذه نشطة.';
...
$_['klarna_checkout_account_locale']						  = 'رمز اللغة لكل حساب. رمز اللغة المكون من حرفين مع رمز البلد المكون من حرفين وفقًا لـ RFC 1766. (على سبيل المثال ، en-gb للإنجليزية البريطانية أو sv-se للغة السويدية)
';
$_['entry_currency']					  = 'العمله';
$_['entry_merchant_id']					  = 'معرف التاجر (MID)';
$_['entry_secret']						  = 'الرمز السري العام';
$_['entry_environment']					  = 'البيئة (مباشر/تجربيبي)';
$_['entry_country']						  = 'المدينة';
$_['entry_shipping']					  = 'مدن الشحن';
$_['klarna_checkout_account_shipping']					  = 'ستكون جميع البلدان ضمن هذه المنطقة الجغرافية متاحة للاختيار في Klarna iFrame
.';
$_['entry_api']							  = 'موقع الAPI';
$_['klarna_checkout_account_api']							  = 'بالنسبة إلى مستخدمي أوروبا ، لا توفر Klarna منطقة العميل. هذا يعني أن خيارات الشحن المحددة للمنطقة لن تعمل.';
...
$_['entry_sftp_username']				  = 'SFTP Username:<br /><span class="help">SFTP username provided by your account manager</span>';
$_['entry_sftp_password']				  = 'SFTP Password:<br /><span class="help">SFTP password provided by your account manager</span>';
$_['entry_process_settlement']			  = 'Process Settlement Files:';
$_['entry_settlement_order_status']		  = 'Order Status:<br /><span class="help">Order status that processed settlement orders will change to.</span>';
