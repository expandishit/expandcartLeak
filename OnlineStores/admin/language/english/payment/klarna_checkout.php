...
$_['entry_total']						  = 'Total';
$_['klarna_checkout_total_note']						  = 'The checkout total the order must reach before this payment method becomes active.';
...
$_['klarna_checkout_account_locale']						  = 'Locale code for each account. Two-letter language code combined with two-letter country code according to RFC 1766. (e.g. en-gb for British English or sv-se for Swedish)';
...
$_['klarna_checkout_account_shipping']					  = 'All countries within this geo zone will be available to select in the Klarna iFrame.';
$_['entry_api']							  = 'API Location';
$_['klarna_checkout_account_api']							  = 'For Europe users, Klarna Checkout doesn\'t provide the customer region. This means that region specific shipping options will not work (Country specific shipping is fine)';
