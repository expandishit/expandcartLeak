...
$_['entry_length_class']           = 'Length Unit:<span class="help">Set to centimeters or inches.</span>';
...
// language for create shipment
$_['text_save']                    = 'Creat Shipment';
$_['please_wait']                  = 'Wait';
$_['text_shipment_settings']       = 'UPS Settings Shipment';
$_['text_description']             = ' Shipment Description';
$_['text_name']                    = ' Name';
$_['text_attention_name']          = 'Attention Name';
$_['text_tax_identification_number']= 'Tax Identification Number';
$_['text_phone_number']            = ' Phone  Number';
$_['text_shipper_number']          = 'Shipper   Number';
$_['text_address_line']            = ' Address Line';
$_['text_city']                    = ' City ';
$_['text_state_province_code']     = ' State Province Code ';
$_['text_postal_code']             = '  Postal Code';
$_['text_country_code']            = '  Country  Code';
$_['text_shipper_setting']         = ' Shipper Information';
$_['text_customer_information']    = ' Customer Information';
$_['text_fax_number']              = ' Fax';
$_['text_shipment_place']          = ' Where Shipment Place ! ';
$_['text_payment_information']     = 'Payment Information ';
$_['text_shipment_charge']         = 'Shipment Charge ';
$_['text_type']                    = ' Type ';
$_['text_account_number']          = ' Account Number(UPS Account) ';
$_['text_service']                 = ' Service ';
$_['text_service_code']            = ' Service Code ';
$_['text_service_description']     = ' Service Description';
$_['text_label_image_format']      = ' Label Image Format (Gif,etc...)';
$_['text_package_settings']        = ' Package Settings';
$_['text_package_description']     = ' Package Description';
$_['text_packaging_code']          = ' Packaging code';
$_['text_packaging_weight_code']  = ' Package Weight code';
$_['text_packaging_weight']       = '  Weight ';
$_['error_shipper']               = '  Re-Confirm Shipper Settings';
$_['error_customer']              = '  Re-Confirm Customer Settings';
$_['error_attention']             = '  Attention';
$_['error_shipper_place']         = '  Re-Confirm Shipment Place Settings';
$_['error_payment']               = '  Re-Confirm Payments Settings';
$_['error_package']               = '  Re-Confirm Package Settings';
$_['error_service']               = '  Re-Confirm Service Settings';
$_['ups_error_warning']   = 'Warning: UPS API Error!';

$_['ups_success_message'] = 'Success: Order Created Successfully';
