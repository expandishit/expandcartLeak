...
$_['text_success']         = 'Başarı: Cowpay ödeme modülünü değiştirdiniz!'; 
...
$_['help_notify_url']          = 'Cowpay & # 8217; nin IPN\'si fatura durumu güncellemelerini bu URL\'ye gönderecektir'; 
$_['entry_return_url']         = 'Dönüş URL\'si'; 
$_['help_return_url']          = 'Cowpay, faturanın başarılı bir şekilde ödenmesinin ardından bu URL için kullanıcıya bir yönlendirme bağlantısı sağlayacaktır'; 
$_['entry_debug_mode']         = 'Hata ayıklama modu'; 
$_['help_debug_mode']          = 'Cowpay günlüğüne ek bilgi kaydeder'; 
$_['entry_default']            = 'Varsayılan'; 
$_['entry_contact_cowpay']     = "CowPay ile İletişim"; 
// Error
$_['error_permission']         = 'Uyarı: Cowpay ödeme modülünü değiştirme izniniz yok.'; 

$_['erorr_merchant_code']      = 'Satıcı Kodu gereklidir (doğrulanmış ödeme bildirimleri için)'; 
$_['erorr_merchant_hash_key']      = 'Satıcı Karma Anahtarı gereklidir (doğrulanmış ödeme bildirimleri için)'; 
$_['error_notify_url']         = 'Bildirim URL\'si gerekli'; 
$_['error_return_url']         = 'Dönüş URL\'si gereklidir'; 
$_['error_api_key_valid']      = 'API Anahtarının geçerli bir Cowpay API Erişim Anahtarı olması gerekir'; 
