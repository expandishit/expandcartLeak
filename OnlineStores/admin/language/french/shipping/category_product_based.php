...
$name = 'Category & Product Based Shipping';
...
$_['text_backup_saved_to']				= 'Backup saved on';
...
// Extension Settings
//------------------------------------------------------------------------------
$_['tab_extension_settings']			= 'General Settings';
$_['heading_extension_settings']		= 'General Settings';

$_['entry_status']						= 'Status';
$_['help_status']						= 'Set the status for the method as a whole.';

$_['entry_sort_order']					= 'Sort Order';
$_['help_sort_order']					= 'The sort order for the method, relative to other shipping methods.';
...
$_['help_testing_mode']					= 'Enable testing mode if things are not working as expected on the front end.';

$_['entry_hide_shipping']				= 'Hide Shipping Methods ';

$_['help_hide_shipping']					= 'If enabled, it means that each product must have an applied rule, otherwise we do not show any shipping method';
// Admin Panel Settings
$_['heading_admin_panel_settings']		= 'Admin Panel Settings';

$_['entry_autosave']					= 'Automatic Saving';
$_['help_autosave']						= 'Choose whether settings are automatically saved or not.';
...
$_['help_total_value']					= 'The cart&#39;s Sub-Total is normally used for calculations involving the total. To change this, use one of the following:<br /><br />&bull; <b>Pre-Discounted Sub-Total:</b> the sub-total of all products&#39; original prices, ignoring Special or Discount prices<br /><br />&bull; <b>Non-Discounted Sub-Total:</b> the sub-total not including products with Special or Discount pricing<br /><br />&bull; <b>Taxed Sub-Total:</b> the sub-total including any tax on products<br /><br />&bull; <b>Total:</b> the total at the relative Sort Order of the "Shipping" Order Total<br /><br />Products that do not require shipping are NOT included in values based on the sub-total.';
...
$_['help_location_comparison']			= 'By default, shipping methods compare location criteria against the shipping address. Use this setting to change this behavior.';
...
$_['help_product_groups']				= 'Product groups are used to restrict charges based on a group of categories, brands, products, attributes, and/or options.';
...
$_['text_all_database_tables']			= 'All';
...
$_['standard_error']					= '<strong>Error:</strong> You do not have permission to modify this method!';
$_['standard_warning']					= '';
...
$_['help_product_groups']				= 'Product groups are used to restrict charges based on a group of categories, brands, and/or products.';
?>