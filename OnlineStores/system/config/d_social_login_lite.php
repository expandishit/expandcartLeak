...
$_['d_social_login_settings'] = array(
    ...
    "providers" => array( 
      ...
      "Google" => array( 
        "enabled" => true,
        "keys"    => array( "id" => "", "secret" => "", "android_client_id" => "", "ios_client_id" => ""),
      ...
      "Twitter" => array(
        ...
        "background_color_active" => '#00aced',
      ),
      ...
      "Instagram" => array(
        ...
        "keys"  => array(
          ...
          "background_color_active" => '#C13584',
        ),
    ),
    "debug_mode" => false,
    ...
    //image/data/d_social_login/bg.png
    "background_img" => "data/d_social_login/bg.png",
  );
