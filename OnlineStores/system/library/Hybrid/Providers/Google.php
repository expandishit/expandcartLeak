...
//                $response = $this->api->api("https://www.googleapis.com/oauth2/v3/userinfo");
                  $response = $this->api->api("https://www.googleapis.com/oauth2/v1/userinfo?alt=json");
		...
		$this->user->profile->photoURL = (property_exists($response, 'picture')) ? substr($response->picture, 0, -2) . "200"  : '';
