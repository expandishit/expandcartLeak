...
Class Ssh2CrontabManager {
    ...
    public function exec(){
        ...
        try {
            ...
            // $result_code = $output = null; //0 for success
            // @exec($command_string, $output, $result_code); 
            // if ( $result_code != 0) throw new Exception("Unable to execute the specified commands: <br />{$command_string}");
        }
        catch(Exception $e){
            $this->error_message($e->getMessage());
        }
