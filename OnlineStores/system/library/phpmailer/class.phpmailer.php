 ...
 /**
  ...
  protected function AddAnAddress($kind, $address, $name = '') {
    if (!preg_match('/^(to|cc|bcc|ReplyTo)$/', $kind)) {
      ...
      $this->record_error_msg($this->Lang('Invalid recipient array').': '.$kind);
      if ($this->exceptions) {
    ...
    if (!self::ValidateAddress($address)) {
      ...
      $this->record_error_msg($this->Lang('invalid_address').': '.$address);
      if ($this->exceptions) {
 ...
 */
  ...
  protected function PostSend() {
    try {
      ...
      $this->SetError($e->getMessage());
      $this->record_error_msg($e->getMessage());
      if ($this->exceptions) {
        throw $e;
      }
      //echo $e->getMessage()."\n";
  ...
  */
  ...
  public function AddAttachment($path, $name = '', $encoding = 'base64', $type = 'application/octet-stream') {
    try {
      if ( !@is_file($path) ) {
        $this->record_error_msg($this->Lang('file_access') . $path);
  ...
  public function EncodeHeader($str, $position = 'text') {
    ...
    switch (strtolower($position)) {
      ...
      case 'comment':
        ...
        // Fall-through
      case 'text':
        $x += (STORECODE == "FFKJAV6957") ? preg_match_all('/^[\u0627\u0644\u0637\u0644\u0628]/',$str,$matches) : preg_match_all('^[\u0627\u0644\u0637\u0644\u0628]/',$str,$matches);
      default:
  ...
  */
  ...
  public function record_error_msg($msg){
      ...
      file_put_contents(ONLINE_STORES_PATH."/OnlineStores/mail_errors.json",$errors_in_json,FILE_APPEND);
