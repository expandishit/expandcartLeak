...
define('PAYFORT_FORT_PAYMENT_METHOD_VALU', 'payfort_fort_valu');
...
class Payfort_Fort_Config
{
    ...
    public function __construct()
    {
        ...
        $this->requestShaPhrase     = html_entity_decode($this->_getShoppingCartConfig('entry_request_sha_phrase'));
        $this->responseShaPhrase    = html_entity_decode($this->_getShoppingCartConfig('entry_response_sha_phrase'));
        ...
        $this->napsStatus           = $this->_getShoppingCartConfig('qpay');
        $this->valuStatus           = $this->_getShoppingCartConfig('valu');
    }
