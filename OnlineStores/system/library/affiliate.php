...
class Affiliate {
  	...
  	public function __construct($registry) {
		...
		if (isset($this->session->data['affiliate_id'])) { 
			...
			if ($affiliate_query->num_rows) {
                ...
                $this->sellerAffiliateCode = $affiliate_query->row['seller_affiliate_code'];
    ...
    public function getSellerAffiliateCode() {
        return $this->sellerAffiliateCode;
    }
}
?>