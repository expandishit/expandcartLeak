    ...
    */
    ...
    public function index(){
      $this->language->load_json('payment/' . self::GATEWAY_NAME);
	    ...
	    $this->data['action'] = $this->url->link('payment/tamara/pay');
    ...
    public function pay(){
       ...
       //Create Tamara Checkout session
        ...
        //validate phone number for SAU and UAE and KWt
        ...
        $data = [
  			  ...
  			  'consumer'     => [
  			    ...
  			    'phone_number'  => $this->session->data['payment_address']['phonecode'] . $order_info['payment_telephone'],
  			  ...
  			  'billing_address' => [
  			    ...
  			    'city'          => $order_info['payment_city'] ?:  ($order_info['payment_zone'] ??'__'),
                'country_code'  => $payment_country_code,
  			  ...
  			  'shipping_address' => [
  			    ...
  			    'city'           => $order_info['shipping_city'] ?: ($order_info['payment_city'] ?: '__'),
            ...
            'amount'         => number_format((float)$this->currency->convert($shipping_cost[0]['value'], $this->config->get('config_currency'), $order_info['currency_code']), 2, '.', ''),
  			  ...
  			  'merchant_url'     => [
  			    'success'        => $this->url->link('payment/tamara/success'),
  			    'failure'        => $this->url->link('payment/tamara/failure'),
  			    'cancel'         => $this->url->link('payment/tamara/cancel'),
  			    'notification'   => $this->url->link('payment/tamara/notification'), //a callback for order status changing
  			  ],
  		  ];
