...
class ControllerPaymentPayfortFortQpay extends Controller
{
    ...
    public function index()
    {
        ...
        // if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/payfort_fort_qpay.expand')) {
        //     $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/payfort_fort_qpay.expand';
        // }
        // else {
        //     $this->template = $this->config->get('config_template') . '/template/payment/payfort_fort_qpay.expand';
        // }
        
        $this->template = 'default/template/payment/payfort_fort_qpay.expand';
