...
class ControllerPaymentBitpay extends Controller
{
    ...
    protected function index()
    {
        ...
        // if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/bitpay.expand')) {
        //     $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/bitpay.expand';
        // }
        // else {
        //     $this->template = $this->config->get('config_template') . '/template/payment/bitpay.expand';
        // }

        $this->template = 'default/template/payment/bitpay.expand';
    ...
    public function send()
    {
        ...
        if($bp->error()) {
            ...
            $notify_url = $this->url->link('payment/bitpay/callback', '', 'SSL');
            //$notify_url = str_replace(HTTPS_SERVER, HTTP_CATALOG, $notify_url);
            $return_url = $this->url->link('payment/bitpay/success', '', 'SSL');
