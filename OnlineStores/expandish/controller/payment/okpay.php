...
class ControllerPaymentOkpay extends Controller {
	protected function index() {
        ...
        // if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/okpay.expand')) {
        //     $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/okpay.expand';
        // }
        // else {
        //     $this->template = $this->config->get('config_template') . '/template/payment/okpay.expand';
        // }
        
        $this->template = 'default/template/payment/okpay.expand';
		...
		if ($order_info) {
			...
			if (extension_loaded('curl')) {
				...
				if (
					...
					$this->request->post['ok_txn_gross'] == $this->currency->format($order_info['total'], $order_info['currency'], $order_info['value'], FALSE)
				) {
