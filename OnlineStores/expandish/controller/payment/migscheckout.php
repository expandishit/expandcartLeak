...
class ControllerPaymentMigsCheckout extends Controller {
	protected function index() {
		$this->language->load_json('payment/migscheckout');
		...
		if($this->data['migscheckout_type'] == 1){
            ...
            // if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/migscheckout.expand')) {
            //     $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/migscheckout.expand';
            // }
            // else {
            //     $this->template = $this->config->get('config_template') . '/template/payment/migscheckout.expand';
            // }
            
            $this->template = 'default/template/payment/migscheckout.expand';
	...
	public function callback() {
		...
		if (STORECODE == 'ORVSQ657'){
			$log = new Log("mada_payment.log");
        ...
        // if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/migscheckout_callback.expand')) {
        //     $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/migscheckout_callback.expand';
        // }
        // else {
        //     $this->template = $this->config->get('config_template') . '/template/payment/migscheckout_callback.expand';
        // }
        
        $this->template = 'default/template/payment/migscheckout_callback.expand';
