...
class ControllerPaymentSkrill extends Controller {
	protected function index() {
		...
		$this->language->load_json('payment/skrill');
        
		$this->data['action'] = 'https://www.moneybookers.com/app/payment.pl';
		...
		$this->data['logo'] = $this->config->get('config_url') . 'image/' . STORECODE . '/' . $this->config->get('config_logo');
        ...
        // if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/skrill.expand')) {
        //     $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/payment/skrill.expand';
        // }
        // else {
        //     $this->template = $this->config->get('config_template') . '/template/payment/skrill.expand';
        // }
        
        $this->template = 'default/template/payment/skrill.expand';
