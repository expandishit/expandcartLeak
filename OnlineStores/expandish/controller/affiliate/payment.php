...
class ControllerAffiliatePayment extends Controller {
	...
	public function index() {
		...
		$this->language->load_json('affiliate/payment');
        ...
        if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/payment.expand')) {
            $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/payment.expand';
        }
        else {
            $this->template = $this->config->get('config_template') . '/template/affiliate/payment.expand';
        }
