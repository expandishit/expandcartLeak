...
class ControllerAffiliatePassword extends Controller {
	private $error = array();
  	...
  	public function index() {	
		...
		$this->language->load_json('affiliate/password');
        ...
        if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/password.expand')) {
            $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/password.expand';
        }
        else {
            $this->template = $this->config->get('config_template') . '/template/affiliate/password.expand';
        }
