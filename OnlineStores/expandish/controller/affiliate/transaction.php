...
class ControllerAffiliateTransaction extends Controller {
	public function index() {
		...
		$this->language->load_json('affiliate/transaction');
        ...
        if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/transaction.expand')) {
            $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/transaction.expand';
        }
        else {
            $this->template = $this->config->get('config_template') . '/template/affiliate/transaction.expand';
        }
