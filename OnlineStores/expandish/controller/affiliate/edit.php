...
class ControllerAffiliateEdit extends Controller {
	...
	public function index() {
		...
		$this->language->load_json('affiliate/edit');
        ...
        if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/edit.expand')) {
            $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/affiliate/edit.expand';
        }
        else {
            $this->template = $this->config->get('config_template') . '/template/affiliate/edit.expand';
        }
