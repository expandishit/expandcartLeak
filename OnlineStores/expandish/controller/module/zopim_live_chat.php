...
class ControllerModuleZopimLiveChat extends Controller {
	protected function index() {
        $this->language->load_json('module/zopim_live_chat');
        ...
        if(file_exists(DIR_TEMPLATE . 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/module/zopim_live_chat.expand')) {
            $this->template = 'customtemplates/' . STORECODE . '/' . $this->config->get('config_template') . '/template/module/zopim_live_chat.expand';
        }
        else {
            $this->template = $this->config->get('config_template') . '/template/module/zopim_live_chat.expand';
        }
