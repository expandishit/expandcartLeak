...
class ControllerModuleExternalOrder extends Controller {
    ...
    public function index() {
        ...
        $this->language->load_json('module/external_order');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->redirect($this->url->link("account/externalorder"));
            return;
        }

        $this->template = 'default/template/module/external_order.expand';
