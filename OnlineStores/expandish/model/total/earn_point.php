...
class ModelTotalEarnPoint extends Model
{
    ...
    public function getTotal(&$total_data, &$total, &$taxes)
    {
        ...
        $points = $this->retriveNetworMarketingPoints($reward_point);
    ...
    public function retriveNetworMarketingPoints(&$reward_point)
    {
        $this->load->model('network_marketing/downlines');

        $points = $this->model_network_marketing_downlines->explainEarnPoints($reward_point);
