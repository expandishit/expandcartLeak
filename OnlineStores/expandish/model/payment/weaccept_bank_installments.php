...
class ModelPaymentWeAcceptBankInstallments extends Model
{
	/**
	...
	public function getMethod($address, $total)
	{
		...
		$geo_zone_id = $this->config->get('weaccept_bank_installments_geo_zone_id');

		if ($geo_zone_id != 0 && $this->getGeoZone($geo_zone_id, $address) == false) {
            $method_data = [];
		} else {
            $method_data = array(
                'code'       => 'weaccept_bank_installments',
