...
class ModelCatalogOption extends Model {
	...
	public function getOptionValues($option_id) {
		...
		foreach ($option_value_query->rows as $option_value) {
			if ($option_value['valuable_type'] == 'product' && \Extension::isInstalled('product_builder') && $this->config->get('product_builder')['status']) {
			...
			$option_value_data[] = array(
				...
				'name'            => $opv_product ? $opv_product['name'] : $option_value['name'],
