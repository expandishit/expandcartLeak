$(function() {
	...
	$("#ms-submit-button").click(function() {
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: $('base').attr('href') + 'index.php?route=seller/register-seller/index',
	...
	var uploader = new plupload.Uploader({
		...
		url: $('base').attr('href') + 'index.php?route=seller/register-seller/jxUploadSellerAvatar',
	...
	/////////////// Commercial Image ****************************************
	$("#sellerinfo_commercial_image_files").delegate(".ms-remove", "click", function() {
		$(this).parent().remove();
	});	
	...
	var uploader = new plupload.Uploader({
		...
		//runtimes : 'flash',
		multi_selection:false,
		browse_button: 'ms-file-commercial_image',
		url: $('base').attr('href') + 'index.php?route=seller/register-seller/jxUploadSellerImage',
		flash_swf_url: 'catalog/view/javascript/plupload/plupload.flash.swf',
		silverlight_xap_url : 'catalog/view/javascript/plupload/plupload.silverlight.xap',
		...
		init : {
			FilesAdded: function(up, files) {
				$('#error_sellerinfo_commercial_image').html('');
				up.start();
			},
			...
			FileUploaded: function(up, file, info) {
				...
				if (!$.isEmptyObject(data.errors)) {
					...
					$('#error_sellerinfo_commercial_image').append(errorText).hide().fadeIn(2000);
				}

				if (!$.isEmptyObject(data.files)) {
					for (var i = 0; i < data.files.length; i++) {
						$("#sellerinfo_commercial_image_files").html(
						'<div class="ms-image">' +
						'<input type="hidden" value="'+data.files[i].name+'" name="seller[commercial_image_name]" />' +
						'<img src="'+data.files[i].thumb+'" />' +
						'<span class="ms-remove"></span>' +
						'</div>').children(':last').hide().fadeIn(2000);
					}
			...
			Error: function(up, args) {
				$('#error_sellerinfo_commercial_image').append(msGlobals.uploadError).hide().fadeIn(2000);
				console.log('[error] ', args);
			}
		}
	}).init();
	...
	/////////////// Industerial Image ****************************************
	$("#sellerinfo_license_image_files").delegate(".ms-remove", "click", function() {
		$(this).parent().remove();
	});	
	...
	var uploader = new plupload.Uploader({
		...
		//runtimes : 'flash',
		multi_selection:false,
		browse_button: 'ms-file-license_image',
		url: $('base').attr('href') + 'index.php?route=seller/register-seller/jxUploadSellerImage',
		flash_swf_url: 'catalog/view/javascript/plupload/plupload.flash.swf',
		silverlight_xap_url : 'catalog/view/javascript/plupload/plupload.silverlight.xap',
		...
		init : {
			FilesAdded: function(up, files) {
				$('#error_sellerinfo_license_image').html('');
				up.start();
			},
			...
			FileUploaded: function(up, file, info) {
				...
				if (!$.isEmptyObject(data.errors)) {
					...
					$('#error_sellerinfo_license_image').append(errorText).hide().fadeIn(2000);
				}

				if (!$.isEmptyObject(data.files)) {
					for (var i = 0; i < data.files.length; i++) {
						$("#sellerinfo_license_image_files").html(
						'<div class="ms-image">' +
						'<input type="hidden" value="'+data.files[i].name+'" name="seller[license_image_name]" />' +
						'<img src="'+data.files[i].thumb+'" />' +
						'<span class="ms-remove"></span>' +
						'</div>').children(':last').hide().fadeIn(2000);
					}
			...
			Error: function(up, args) {
				$('#error_sellerinfo_license_image').append(msGlobals.uploadError).hide().fadeIn(2000);
				console.log('[error] ', args);
			}
		}
	}).init();
	...
	/////////////// Tax Image ****************************************
	$("#sellerinfo_tax_image_files").delegate(".ms-remove", "click", function() {
		$(this).parent().remove();
	});	
	...
	var uploader = new plupload.Uploader({
		...
		//runtimes : 'flash',
		multi_selection:false,
		browse_button: 'ms-file-tax_image',
		url: $('base').attr('href') + 'index.php?route=seller/register-seller/jxUploadSellerImage',
		flash_swf_url: 'catalog/view/javascript/plupload/plupload.flash.swf',
		silverlight_xap_url : 'catalog/view/javascript/plupload/plupload.silverlight.xap',
		...
		init : {
			FilesAdded: function(up, files) {
				$('#error_sellerinfo_tax_image').html('');
				up.start();
			},
			...
			FileUploaded: function(up, file, info) {
				...
				if (!$.isEmptyObject(data.errors)) {
					...
					$('#error_sellerinfo_tax_image').append(errorText).hide().fadeIn(2000);
				}

				if (!$.isEmptyObject(data.files)) {
					for (var i = 0; i < data.files.length; i++) {
						$("#sellerinfo_tax_image_files").html(
						'<div class="ms-image">' +
						'<input type="hidden" value="'+data.files[i].name+'" name="seller[tax_image_name]" />' +
						'<img src="'+data.files[i].thumb+'" />' +
						'<span class="ms-remove"></span>' +
						'</div>').children(':last').hide().fadeIn(2000);
					}
			...
			Error: function(up, args) {
				$('#error_sellerinfo_tax_image').append(msGlobals.uploadError).hide().fadeIn(2000);
				console.log('[error] ', args);
			}
		}
	}).init();
	...
	/////////////// Image ID ****************************************
	$("#sellerinfo_image_id_files").delegate(".ms-remove", "click", function() {
		$(this).parent().remove();
	});	
	...
	var uploader = new plupload.Uploader({
		...
		//runtimes : 'flash',
		multi_selection:false,
		browse_button: 'ms-file-image_id',
		url: $('base').attr('href') + 'index.php?route=seller/register-seller/jxUploadSellerImage',
		flash_swf_url: 'catalog/view/javascript/plupload/plupload.flash.swf',
		silverlight_xap_url : 'catalog/view/javascript/plupload/plupload.silverlight.xap',
		...
		init : {
			FilesAdded: function(up, files) {
				$('#error_sellerinfo_image_id').html('');
				up.start();
			},
			...
			FileUploaded: function(up, file, info) {
				...
				if (!$.isEmptyObject(data.errors)) {
					...
					$('#error_sellerinfo_image_id').append(errorText).hide().fadeIn(2000);
				}

				if (!$.isEmptyObject(data.files)) {
					for (var i = 0; i < data.files.length; i++) {
						$("#sellerinfo_image_id_files").html(
						'<div class="ms-image">' +
						'<input type="hidden" value="'+data.files[i].name+'" name="seller[image_id_name]" />' +
						'<img src="'+data.files[i].thumb+'" />' +
						'<span class="ms-remove"></span>' +
						'</div>').children(':last').hide().fadeIn(2000);
					}
			...
			Error: function(up, args) {
				$('#error_sellerinfo_image_id').append(msGlobals.uploadError).hide().fadeIn(2000);
				console.log('[error] ', args);
			}
		}
	}).init();
	...
	$(".seller_files").delegate(".ms-remove", "click", function() {
		$(this).parent().remove();
	});
