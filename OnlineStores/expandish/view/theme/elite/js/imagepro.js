    ...
    $('div.options').click(function(){poipCheckEventsForSelects();});
      ...
      $(document).ready(function(){
        ...
        // 		});
        //zoom when change select color :
        var selectColor      = $('select.form-control'),
            owlCarouselStage = $('.owl-carousel .owl-stage');
            zoomChangeColor();
            selectColor.on('change', function(){
              zoomChangeColor();  
            });
        function zoomChangeColor(){
          var owlCarouselStage = $('.owl-carousel .owl-stage');
          owlCarouselStage.children().first().children().addClass('selected').trigger('click');
          owlCarouselStage.children().first().find('a').addClass('selected').trigger('click');
        }