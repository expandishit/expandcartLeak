      ...
      function poip_option_value_selected(option) {
        ...
        for(i=0;i<uniqueImages.length;i++){
         galleryContent = galleryContent + "<li style=\"overflow: hidden; float: left; width: 70px; height: 70px;\"><a href=\"#\"  data-image=\" "+uniqueImages[i]+" \" data-zoom-image=\""+uniqueImages[i]+"\"><img src=\""+uniqueImages[i]+"\"></a></li>"
        }
        $('.gallery-control ul').empty();
        $('.gallery-control ul').html(galleryContent);
        ...
        $('#gal1 .mid img').attr("src",images_to_show[0]);
