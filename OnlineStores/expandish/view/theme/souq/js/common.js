$(document).ready(function() {
	...
	let maxHeightCardTitle = 0;
  $(".title14").each(function(){
    if($(this).height() > maxHeightCardTitle) {
		maxHeightCardTitle = $(this).height() + 12;
    }
  });
  $(".title14").height(maxHeightCardTitle);
	...
	/* Search */
	$('.goSearch,.submit-form').bind('click', function() {
