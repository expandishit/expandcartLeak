$(document).ready(function() {
	...
	// For equal all this dif height the same
	function sameHeightHeading( element ) {
		$maxHeight = 0;
	...
	sameHeightHeading(".product-title");
	sameHeightHeading(".thumbnail img");
	...
	$(document).on('click', ".form-qty .btn-number", function() {
	 ...
	 $('#cart_wrap .box.box-border .qc-checkout-product').addClass('table-responsive');
	/* Search */
                ...
                $.each(json['error'], function (index, error) {
                    if (Object.prototype.toString.call(error) === "[object Object]") {
                        ...
                        for (var i in tempError) {
                            error += tempError[i] + '<br>';
                        }    
                    }
                    
                    if (Object.prototype.toString.call(error) === "[object String]" && error.length) {
