jQuery(document).ready(function () {
    ...
    // To adjust Zoom div src
    $('.product-add-form .form-check').each(function() {

        $(this).find('input').change(function() {

            let bigImgSrc = $('.product-main-image .product-main-image__item .product-zoom').attr('src');

            $('.zoomContainer:last .zoomWindowContainer div').css('background-image', `url("${bigImgSrc}")`);
...
$(document).ready(function () {
    ...
    if( $('div').hasClass('innerpages') ){
        $('header').removeClass('layout8-index');
    }
...
// start EC-24552
$( "#loader-wrapper" ).parent().css({ "background": "none"} );
// end EC-24552
