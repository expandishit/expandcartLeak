$(document).ready(function () {
	...
	// Global Function calling by selector
	...
	// For product title same height
	setTimeout(()=>{
	    sameHeight(".new-product6 .product-title a");
	}, 1000)
...
$('body').on('click','.product-list-thumb li', function(){            
	// Get Source Image.
	let imgSource = $(this).find('a').data('standard');
	$('.block.block-product-image .product-image img').attr('src',imgSource)
});
