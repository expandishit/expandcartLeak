(function($){
    ...
    function slick_carousel_rtl(){
        

        $('.kt-owl-carousel').slick({
            dots: false,
            infinite: true,
            speed: 300,
            // autoplay: true,
...
function slick_carousel(){
    ...
    function resizeTopmenu(){
        ...
        if($(window).width()+scrollCompensate() < 1025){
            $("#main-menu li.dropdown:not(.active) > .dropdown-toggle").attr('data-toggle','dropdown');
        }else{
    ...
    ***  Auto width megamenu
    ...
    const unifyProductHeight = () => {
        let parent = document.querySelector('#catProducts');
        if(!parent){
            return
        }else{
            ...
            products.forEach(el => {
                return el.style.height = heighstval+'px';
            })
        }
    }
    ...
    $(document).ready(function() {
        ...
        // Zoom
        if($('.easyzoom').length >0 && $(window).width() > 992){
            ...
            $('.thumbnails').on('click', 'a', function(e) {
                ...
                $(".product-image a img" ).attr('src',ImgSrc);
                var $easyzoom = $('.easyzoom').easyZoom();
            ...
            $(".block-product-image .product-image").hover(function(){

                setTimeout(function(){ 
                    $(".easyzoom-flyout img" ).attr('src',ImgSrc);
...
$(document).ready(function() {
    ...
    function slick_carousel_rtl(){        
        $('.kt-owl-carousel').not('.slick-initialized').slick({
            dots: false,
            infinite: true,
            speed: 300,
            // autoplay: true,
