$(document).ready(function() {
  ...
  // Equal item-product15 height
	$maxHeight = 0;
	$('.item-product15').each(function(){
		if($(this).height() > $maxHeight) {
		$maxHeight = $(this).height();
		}
	});
	$('.item-product15').height($maxHeight);

    // Equal list-adv15 banner-image height
	$maxHeight = 0;
	$('.list-adv15 .banner-image').each(function(){
		if($(this).height() > $maxHeight) {
		$maxHeight = $(this).height();
		}
	});
	$('.list-adv15 .banner-image').height($maxHeight);

    
	$('.currency-language a ').click(function(event) {
