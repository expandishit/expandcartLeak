...
('FontAwesome_Icons', 'تدوير لليمين', 'fa fa-rotate-right', 'en', 9),
('FontAwesome_Icons', 'Umbrella', 'fa fa-umbrella', 'en', 10),
('FontAwesome_Icons', 'شمسية', 'fa fa-umbrella', 'en', 10),
('FontAwesome_Icons', 'Tags', 'fa fa-tags', 'en', 11),
('FontAwesome_Icons', 'علامات', 'fa fa-tags', 'en', 11),
...
('Object_Position', 'Top', 'pos-top', 'en', 1),
('Object_Position', 'فى الاعلى', 'pos-top', 'ar', 1),
('Object_Position', 'Middle', 'pos-middle', 'en', 2),
('Object_Position', 'فى المنتصف', 'pos-middle', 'ar', 2),
('Object_Position', 'Bottom', 'pos-bottom', 'en', 3),
('Object_Position', 'فى الاسفل', 'pos-bottom', 'ar', 3);
