      ...
      function poip_option_value_selected(option) {
        ...
        for(i=0;i<uniqueImages.length;i++){
         galleryContent = galleryContent + "<li><a  data-image=\" "+uniqueImages[i]+" \" data-zoom-image=\""+uniqueImages[i]+"\"><img src=\""+uniqueImages[i]+"\"></a></li>"
        }
        $('.product-images-carousel').empty();
        $('.product-images-carousel').html("<ul id=\"smallGallery\">" + galleryContent + "</ul>");

        

        //pass the first image to the zoom preview 
        $('.product-main-image__item img').attr("src",uniqueImages[0]);
        ...
        // $('.product-images-carousel ul').slick('unslick');
