...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;height:<?php echo $logo_height;?>px" /></a>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;"><a href="<?php echo $link; ?>">Order Details</a></p>
  <?php } ?>
  <?php if ($download) { ?>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tr>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
        ...
        <b><?php echo $text_delivery_day; ?></b> <?php echo $order_delivery_slot['day_name'] ; ?> <br />
        <b><?php echo $text_delivery_date; ?></b> <?php echo $order_delivery_slot['delivery_date'] ; ?> <br />
        <b><?php echo $text_delivery_slot; ?></b> <?php echo $order_delivery_slot['slot_description'] ; ?> <br />
        <?php } ?>
      </td>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_email; ?></b> <?php echo $email; ?><br />
        ...
        <?php if ($custom_fields['confirm']) {
              foreach ($custom_fields['confirm'] as $field) {
          ?>
        <b><?php echo $field['field_title']; ?></b>:
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tbody>
    <tr>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $payment_address; ?>
        <br />

        <?php if ($custom_fields['payment_address']) {
              foreach ($custom_fields['payment_address'] as $field) {
          ?>
        <b><?php echo $field['field_title']; ?></b>:
        <?php echo $field['value']; ?><br>
        <?php } } ?>
      ...
      <?php if ($shipping_address) { ?>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $shipping_address; ?><?php } ?>
        <br />
        <?php if ($custom_fields['shipping_address']) {
              foreach ($custom_fields['shipping_address'] as $field) {
          ?>
        <b><?php echo $field['field_title']; ?></b>:
        <?php echo $field['value']; ?><br />
        <?php } } ?>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tr>
      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;" colspan="2">
        <?php if ( $product['thumb'] != null && !empty($product['thumb']) ) {?>
        <img src="<?php echo $product['thumb'] ?>"
             style="max-width: 50vw; margin: 0; border: 0; width: 100px; padding: 10px; display: block;"
             width="100"
        >
        <?php } ?>
        <?php
           echo $product['name'];
           if($product['productCodeData'] != null ){
            foreach($product['productCodeData'] as $key=>$codeData){
        echo "<p>".$codeData['code']."</p>";
        }
        }
        ?>
