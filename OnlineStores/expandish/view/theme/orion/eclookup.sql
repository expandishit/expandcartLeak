...
('FontAwesome_Icons', 'Phone', 'fa fa-phone', 'en', 19),
('FontAwesome_Icons', 'هاتف', 'fa fa-phone', 'ar', 19),
('FontAwesome_Icons', 'Call', 'fa fa-university', 'en', 20),
('FontAwesome_Icons', 'مكالمة', 'fa fa-university', 'ar', 20),
...
('ProductsByType_Select', 'Latest Products', 'LatestProducts', 'en', 1),
('ProductsByType_Select', 'احدث المنتجات', 'LatestProducts', 'ar', 1),
('ProductsByType_Select', 'BestSeller Products', 'BestSellerProducts', 'en', 2),
('ProductsByType_Select', 'المنتجات الاكثر مبيعاً', 'BestSellerProducts', 'ar', 2),
('ProductsByType_Select', 'المنتجات المميزة', 'SpecialProducts', 'ar', 3),
('ProductsByType_Select', 'Special Products', 'SpecialProducts', 'en', 3),
