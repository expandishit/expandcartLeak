      ...
      function poip_option_value_selected(option) {
        ...
        for(i=0;i<uniqueImages.length;i++){
         galleryContent = galleryContent + "<li><a href=\"#\"  data-image=\" "+uniqueImages[i]+" \" data-zoom-image=\""+uniqueImages[i]+"\"><img src=\""+uniqueImages[i]+"\"></a></li>"
        }
        $('.product-images-carousel ul').slick('destroy');
        $('#smallGallery').empty();
        $('#smallGallery').html(galleryContent);
        ...
        $('.product-zoom').attr("src",images_to_show[0]);
        $('.product-zoom').data('zoom-image',images_to_show[0]);
        $('.product-zoom').css('margin-bottom','40px');
