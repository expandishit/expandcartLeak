...
if($(window).width()<768){
   ...
   // calculate mega menue posetion in mulible lines case
    $('.main-nav.main-nav9 > ul > li').mouseenter(function() {
        let parentPosetion = $('.main-nav.main-nav9 > ul').offset().top + $('.main-nav.main-nav9 > ul').height();
        let itemPosetion = $(this).offset().top + $(this).height();
        let itemTop = (parentPosetion - itemPosetion);
        let menueTop = ($('.main-nav.main-nav9 > ul').height() - itemTop) + 'px';
