...
jQuery(function($) {
	...
	var priceSlider = document.getElementById('mfilter-price-slider');
	...
	// When the slider changes, write the value to the tooltis.
	priceSlider.noUiSlider.on('update', function( values, handle, e ){
		tooltips[handle].innerHTML = Math.round(values[handle]);		
		$('#mfilter-opts-price-min').val(Math.floor(values[0]));
		$('#mfilter-opts-price-max').val(Math.floor(values[1]));
